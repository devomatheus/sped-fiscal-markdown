# Bloco C - Versão 3.0.2

**Data de Criação:** 2019-05-21  
**Páginas:** 54-140  
**Versão:** 3.0.2
...
02 QTD_LIN_ Quantidade total de linhas do N - - O O O
B Bloco B
Observações:
Nível hierárquico - 1
...
pelo registro. As NFC-e não devem ser escrituradas nas entradas. A partir de janeiro de 2020, também poderá ser
informado o Registro C185, a critério de cada UF.
Exceção 10: nos casos em que houver informações complementares do item (tabela 5.6 da Nota Técnica 2018.001, instituída
pelo Ato COTEPE/ICMS nº 44/2018) a serem prestadas no Registro C177 (utilização a partir de 01/01/2019), o registro C170
deverá ser informado, inclusive para NF-e de emissão própria. A UF determinará a obrigatoriedade deste registro.
...
15 VL_ABAT_NT Abatimento não tributado e não comercial N - 02 OC OC
...
23 VL_BC_ICMS_S Valor da base de cálculo do ICMS substituição N - 02 OC OC
T tributária
...
preenchimento obrigatório para COD_MOD igual a “55” e “65”. Para confirmação inequívoca de que a chave da NF-e/NFC-
e corresponde aos dados informados do documento, é comparado o CNPJ base existente na CHV_NFE com o campo CNPJ
...
1 REG Texto fixo contendo “C101” C 004 - O O
2 VL_FCP_UF_DEST Valor total relativo ao Fundo de Combate à N - 02 O O
Pobreza (FCP) da UF de destino
3 VL_ICMS_UF_DEST Valor total do ICMS Interestadual para a UF N - 02 O O
de destino
4 VL_ICMS_UF_REM Valor total do ICMS Interestadual para a UF N - 02 O O
do remetente
Nível hierárquico – 3
Ocorrência - 1:1
...
Destino
Valor ICMS UF Campo “VL_ICMS_UF_DEST” 40,00
Destino
Valor ICMS UF Campo “VL_ICMS_UF_REM” 60,00
Remetente
Página 60 de 301
...
Nº Campo Descrição Tipo Tam Dec Entr. Saídas
3 REG Texto fixo contendo “C105” C 004 - O O
4 OPER Indicador do tipo de operação: N 001* - O O
0- Combustíveis e Lubrificantes;
1- Leasing de veículos ou faturamento direto.
5 UF Sigla da UF de destino do ICMS_ST C 002* - O O
Observações:
Nível hierárquico - 3
Ocorrência - 1:1
...
02 COD_DA Código do modelo do documento de C 001* - O O
arrecadação :
0 – Documento estadual de arrecadação
1 – GNRE
03 UF Unidade federada beneficiária do C 002* - O O
recolhimento
...
(principal, atualização monetária, juros e
multa)
07 DT_VCTO Data de vencimento do documento de N 008* - O O
arrecadação
08 DT_PGTO Data de pagamento do documento de N 008* - O O
arrecadação, ou data do vencimento, no caso
...
mesma combinação de valores dos campos formadores da chave do registro. A chave deste registro é: Para documentos
Página 63 de 301

--- Página 64 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
emitidos por terceiros: campos IND_EMIT, COD_PART, COD_MOD, SER e NUM_DOC.Para documentos de emissão
própria: campos IND_EMIT, COD_MOD, SER e NUM_DOC.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
2018.001, instituída pelo Ato COTEPE/ICMS nº 44/2018), reproduzida na subseção 1.4 deste guia.
...
03 NUM_DOC_IMP Número do documento de Importação. C 012 - O
...
02 COD_PART Código do participante (campo 02 do C 060 - apresentar OC
Registro 0150):
- transportador, se houver
03 VEIC_ID Placa de identificação do veículo C 007 - OC
automotor
04 QTD_VOL Quantidade de volumes transportados N - - O
05 PESO_BRT Peso bruto dos volumes transportados N - 02 O
(em kg)
06 PESO_LIQ Peso líquido dos volumes transportados N - 02 O
(em kg)
...
Temperatura em graus Celsius utilizada OC
07 TEMPER para quantificação do volume de N - 01
combustível
08 QTD_VOL Quantidade de volumes transportados N - - O
PESO_BRT Peso bruto dos volumes transportados N - 02 O
09
(em kg)
PESO_LIQ Peso líquido dos volumes transportados N - 02 O
10
(em kg)
...
de terceiros.
Conforme item 2.4.2.2.1 da Nota Técnica 2018.001, o termo “item” é aplicado às operações fiscais que envolvam
mercadorias, serviços, produtos ou quaisquer outros itens concernentes às transações fiscais suportadas pelo documento,
como, por exemplo, nota fiscal complementar, nota fiscal de ressarcimento, transferências de créditos e outros casos.
Validação do Registro: Não podem ser informados para um mesmo documento fiscal dois ou mais registros com o
...
04 DESCR_COMP Descrição complementar do item como adotado C - - OC OC
L no documento fiscal
...
16 VL_BC_ICMS_ Valor da base de cálculo referente à substituição N - 02 OC OC
ST tributária
...
26 VL_BC_PIS Valor da base de cálculo do PIS N - 02 OC
27 ALIQ_PIS Alíquota do PIS (em percentual) N 008 04 OC OC
28 QUANT_BC_PI Quantidade – Base de cálculo PIS N - 03 OC
S
29 ALIQ_PIS Alíquota do PIS (em reais) N - 04 OC
30 VL_PIS Valor do PIS N - 02 OC OC
31 CST_COFINS Código da Situação Tributária referente ao N 002* - OC OC
COFINS.
32 VL_BC_COFIN Valor da base de cálculo da COFINS N - 02 OC
S
33 ALIQ_COFINS Alíquota do COFINS (em percentual) N 008 04 OC OC
34 QUANT_BC_C Quantidade – Base de cálculo COFINS N - 03 OC
OFINS
35 ALIQ_COFINS Alíquota da COFINS (em reais) N - 04 OC
...
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C174" C 004 - Não apresentar O
02 IND_ARM Indicador do tipo da arma de fogo: C 001* - O
0 - Uso permitido;
1 - Uso restrito
03 NUM_ARM Numeração de série de fabricação da C - - O
arma
04 DESCR_COMPL Descrição da arma, compreendendo: C - - O
número do cano, calibre, marca,
capacidade de cartuchos, tipo de
...
02 IND_VEIC_OPER Indicador do tipo de operação com C 001* - O O
veículo:
...
02 COD_MOD_ULT_ Código do modelo do documento fiscal C 002* - apresentar O
E relativa a última entrada
03 NUM_DOC_ULT_ Número do documento fiscal relativa a N 009 - O
E última entrada
04 SER_ULT_E Série do documento fiscal relativa a última C 003 - OC
entrada
05 DT_ULT_E Data relativa a última entrada da N 008* - O
mercadoria
06 COD_PART_ULT Código do participante (do emitente do C 060 - O
_E documento relativa a última entrada)
07 QUANT_ULT_E Quantidade do item relativa a última N - 03 O
entrada
08 VL_UNIT_ULT_E Valor unitário da mercadoria constante na N - 03 O
NF relativa a última entrada inclusive
despesas acessórias.
09 VL_UNIT_BC_ST Valor unitário da base de cálculo do N - 03 O
imposto pago por substituição.
10 CHAVE_NFE_UL Número completo da chave da NFe N 044* - OC
T_E relativo à última entrada
11 NUM_ITEM_ULT Número sequencial do item na NF entrada N 003 - OC
_E que corresponde à mercadoria objeto de
pedido de ressarcimento
12 VL_UNIT_BC_IC Valor unitário da base de cálculo da N - 02 OC
MS_ULT_E operação própria do remetente sob o
regime comum de tributação
13 ALIQ_ICMS_ULT Alíquota do ICMS aplicável à última N - 02 OC
_E entrada da mercadoria
14 VL_UNIT_LIMIT Valor unitário da base de cálculo do ICMS N - 02 OC
E_BC_ICMS_ULT relativo à última entrada da mercadoria,
_E limitado ao valor da BC da retenção
(corresponde ao menor valor entre os
campos VL_UNIT_BC_ST e
VL_UNIT_BC_ICMS_ULT_E )
15 VL_UNIT_ICMS_ Valor unitário do crédito de ICMS sobre N - 03 OC
ULT_E operações próprias do remetente, relativo
à última entrada da mercadoria, decorrente
da quebra da ST – equivalente a
...
17 VL_UNIT_RES Valor unitário do ressarcimento (parcial N - 03 OC
ou completo) de ICMS decorrente da
quebra da ST
...
9 - Outros
20 CHAVE_NFE_RE Número completo da chave da NF-e N 044* - OC
T emitida pelo substituto, na qual consta o
valor do ICMS-ST retido
21 COD_PART_NFE_ Código do participante do emitente da NF- C 060 - OC
RET e em que houve a retenção do ICMS-ST –
...
do ICMS-ST
24 ITEM_NFE_RET Número sequencial do item na NF-e em N 003 - OC
que houve a retenção do ICMS-ST, que
corresponde à mercadoria objeto de
pedido de ressarcimento
...
estadual, se houver
27 Valor unitário do ressarcimento (parcial N - 03 OC
VL_UNIT_RES_F ou completo) de FCP decorrente da quebra
CP_ST da ST
...
ou se o emitente informado no campo COD_PART_ULT_E deste registro for o substituído, informar o valor unitário que
...
02 COD_SELO_IPI Código do selo de controle do IPI, C 006* - Apresentar O
conforme Tabela 4.5.2
03 QT_SELO_IPI Quantidade de selo de controle do IPI N 012 - O
aplicada
Observações:
Nível hierárquico - 4
Ocorrência – 1:1
...
02 COD_INF_ITEM Código da informação adicional de C 008* - O O
acordo com tabela a ser publicada pelas
...
04 QUANT_PAD Quantidade total de produtos na unidade N - 03 O
...
interestaduais.
Valor do ICMS-ST a repassar/deduzir O
03 ICMS_ST_REP N - 02
em operações interestaduais
Valor do ICMS-ST a complementar à OC
04 ICMS_ST_COMPL N - 02
UF de destino
Valor da BC de retenção em remessa OC
05 BC_RET promovida por Substituído N - 02
intermediário
06 ICMS_RET Valor da parcela do imposto retido em N’ - 02 OC
...
A obrigatoriedade e a forma de escrituração deste registro serão definidas pela UF de domicílio do contribuinte.
O campo “IND_OPER” do registro pai C100 deve ser igual a “0” - Entrada.
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C180” C 004 - O Não apresentar
02 COD_RESP_RET Código que indica o responsável pela N 001* - O
retenção do ICMS-ST:
1-Remetente Direto
2-Remetente Indireto
3-Próprio declarante
03 QUANT_CONV Quantidade do item N - 06 O
04 UNID Unidade adotada para informar o O
campo QUANT_CONV.
05 VL_UNIT_CONV Valor unitário da mercadoria, N - 06 O
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
06 VL_UNIT_ICMS_OP_C Valor unitário do ICMS operação N - 06 O
ONV própria que o informante teria direito
ao crédito caso a mercadoria estivesse
sob o regime comum de tributação,
considerando unidade utilizada para
informar o campo “QUANT_CONV”.
07 VL_UNIT_BC_ICMS_ST Valor unitário da base de cálculo do N - 06 O
_CONV imposto pago ou retido anteriormente
por substituição, considerando a
unidade utilizada para informar o
campo “QUANT_CONV”.
08 VL_UNIT_ICMS_ST_C Valor unitário do imposto pago ou N - 06 O
ONV retido anteriormente por substituição,
inclusive FCP se devido,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
09 VL_UNIT_FCP_ST_CO Valor unitário do FCP_ST agregado N - 06 OC
NV ao valor informado no campo
“VL_UNIT_ICMS_ST_CONV”
10 COD_DA Código do modelo do documento de C 001* - OC
arrecadação:
0 – Documento estadual de
arrecadação
1 – GNRE
11 NUM_DA Número do documento de arrecadação C - - OC
estadual, se houver
Observação:
Nível hierárquico - 4
Ocorrência 1:1
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
Campo 03 (QUANT_CONV) – Preenchimento: Quantidade do item convertida na unidade de controle de estoque
informada no registro 0200 ou a unidade de comercialização, a critério de cada UF.
Validação: o valor informado no campo deve ser maior que “0” (zero).
Campo 04 (UNID) - Preenchimento: informar a unidade de medida adotada para o controle de ressarcimento/restituição de
ICMS ST. (unidade informada no registro 0200 ou de comercialização, a critério de cada UF). O campo UNID do registro
C170 não é necessariamente igual ao campo UNID deste registro. No registro C170, deve corresponder à unidade de medida
de comercialização do item utilizada no documento fiscal. Nos documentos emitidos por fornecedores (terceiros), a unidade
de comercialização adotada pode não ser à unidade adotada para o cálculo do ressarcimento/restituição de ICMS ST.
...
Campo 05 (VL_UNIT_CONV) – Preenchimento: informar o valor unitário líquido do item/produto (considerando
descontos e acréscimos incondicionais aplicados sobre o valor bruto)
Validação: Caso a unidade informada no campo “VL_UNIT_CONV” seja diferente da informada no registro 0200, deve
existir um registro 0220 correspondente.
Campo 09 (VL_UNIT_FCP_ST_CONV) – Preenchimento: Informar o valor unitário do Fundo de Combate à Pobreza
(FCP) vinculado à substituição tributária que compõe o campo “VL_UNIT_ICMS_ST_CONV”, considerando a unidade
utilizada para informar o campo “QUANT_CONV”, conforme previsão das legislações das UF.
...
A obrigatoriedade e a forma de escrituração deste registro serão definidas pela UF de domicílio do contribuinte.
O campo “IND_OPER” do registro pai C100 deve ser igual a “1” - Saída
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C185” C 004 - Não O
apresentar
02 NUM_ITEM Número sequencial do item no documento N 003 - O
fiscal
03 COD_ITEM Código do item (campo 02 do Registro 0200) C 060 - O
04 CST_ICMS Código da Situação Tributária referente ao N 003* - O
ICMS
05 CFOP Código Fiscal de Operação e Prestação N 004* - O
06 COD_MOT_REST_CO Código do motivo da restituição ou N 005* - O
MPL complementação conforme Tabela 5.7
07 QUANT_CONV Quantidade do item N - 06 O
08 UNID Unidade adotada para informar o campo O
QUANT_CONV.
09 VL_UNIT_CONV Valor unitário da mercadoria, considerando a N - 06 O
unidade utilizada para informar o campo
“QUANT_CONV”.
10 VL_UNIT_ICMS_NA_ Valor unitário para o ICMS na operação, caso N - 06 OC
OPERACAO_CONV não houvesse a ST, considerando unidade
utilizada para informar o campo
“QUANT_CONV”.
11 VL_UNIT_ICMS_OP_C Valor unitário do ICMS que o contribuinte N - 06 OC
ONV teria se creditado referente à operação de
entrada da mercadoria, caso estivesse
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
12 VL_UNIT_BC_ICMS_S Valor médio unitário da Base de Cálculo do N - 06 OC
T_ESTOQUE_CONV ICMS/ST das mercadorias em estoque,
considerando unidade utilizada para informar
o campo “QUANT_CONV”.
13 VL_UNIT_ICMS_ST_E Valor médio unitário do ICMS/ST, incluindo N - 06 OC
STOQUE_CONV FCP ST, das mercadorias em estoque,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”
14 VL_UNIT_FCP_ICMS_ Valor médio unitário do FCP ST agregado N - 06 OC
ST_ESTOQUE_CONV ao ICMS das mercadorias em estoque,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”
15 VL_UNIT_ICMS_ST_C Valor unitário do total do ICMS/ST, N - 06 OC
ONV_REST incluindo FCP ST, a ser restituído/ressarcido,
calculado conforme a legislação de cada UF,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
16 VL_UNIT_FCP_ST_CO Valor unitário correspondente à parcela de N - 06 OC
NV_REST ICMS FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
17 VL_UNIT_ICMS_ST_C Valor unitário do complemento do ICMS, N - 06 OC
ONV_COMPL incluindo FCP ST, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”.
18 VL_UNIT_FCP_ST_CO Valor unitário correspondente à parcela de N - 06 OC
...
Campo 02: (NUM_ITEM ) O campo NUM_ITEM não precisa ser sequencial. Apenas os itens controlados para a
restituição/ressarcimento e complemento de ICMS ST devem ter esse registro preenchido.
Campo 03 (COD_ITEM) - Validação: o valor informado neste campo deve existir no Registro 0200 e constantes do
documento fiscal.
...
Validação: o valor informado no campo deve existir na Tabela de Código Fiscal de Operação e Prestação, conforme Ajuste
SINIEF 07/01, sendo que o primeiro caractere do CFOP deve ser igual a 5, 6 ou 7. O primeiro caractere deve ser o mesmo
para todos os itens de um documento fiscal.
...
b) igual a 1, os campos 10, 12, 13, 14, 15 e 16 devem ser preenchidos e os campos 11, 17 e 18 não devem ser
preenchidos
Página 86 de 301
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
c) igual a 2, os campos 11, 12, 13, 14, 15 e 16 devem ser preenchidos e os campos 10, 17 e 18 não devem ser
preenchidos
d) igual a 3, os campos 10, 12, 13, 14, 17 e 18 devem ser preenchidos e os campos 11, 15 e 16 não devem ser
preenchidos
Campo 07 (QUANT_CONV) – Preenchimento: Quantidade do item convertida na unidade de controle de estoque
informada no registro 0200 ou a unidade de comercialização, a critério de cada UF.
Validação: o valor informado no campo deve ser maior que “0” (zero).
...
da unidade de medida de controle de estoque informada no Registro 0200, deverá ser informado no Registro 0220 o fator de
conversão entre as unidades de medida.
Campo 09 (VL_UNIT_CONV) – Preenchimento: informar o valor unitário líquido do item/produto (considerando
descontos e acréscimos incondicionais aplicados sobre o valor bruto) na unidade utilizada para informar o campo
“QUANT_CONV”.
...
que seria tributada se não houvesse ST, considerando a unidade utilizada para informar o campo “QUANT_CONV”.
...
do contribuinte substituído do qual a mercadoria tenha sido recebida, caso estivesse submetida ao regime comum de
tributação, calculado conforme a legislação de cada UF, considerando unidade utilizada para informar o campo
“QUANT_CONV”.
Campo 12 (VL_UNIT_BC_ICMS_ST_ESTOQUE_CONV) -: Preenchimento: Informar o valor médio unitário da Base de
Cálculo do ICMS/ST retido por substituição tributária que tenha sido recolhido pelo próprio informante ou a título de
reembolso que tenha sido suportado por ele das mercadorias em estoque. O período para o cálculo do valor médio deve
...
retido por substituição tributária que tenha sido recolhido pelo próprio informante ou a título de reembolso que tenha sido
suportado por ele das mercadorias em estoque. Quando a mercadoria estiver sujeita, também, ao FCP adicionado ao
ICMS/ST, neste campo deve ser informado o valor médio unitário total da parcela do ICMS/ST + a parcela do FCP vinculado
a este. O período para o cálculo do valor médio deve atender à legislação de cada UF. Ex. diário, mensal etc.
...
Campo 15 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento:
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido, informar o valor unitário
de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por unidade do item no estoque,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor unitário de ICMS correspondente
ao campo “VL_UNIT_ICMS_OP_CONV_REST”, conforme previsão das legislações das UFs.
b) Nos casos de direito ao crédito do imposto, calculada com base no valor de saída da mercadoria inferior ao valor da
BC/ST, informar o valor unitário de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por
unidade do item no estoque, considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor
unitário de ICMS na operação correspondente ao campo “VL_UNIT_ICMS_NA_OPERACAO_CONV”, conforme
previsão das legislações das UFs.
Campo 16 (VL_UNIT_FCP_ST_CONV_REST) – Preenchimento: Informar o valor unitário do Fundo de Combate à
Pobreza (FCP) vinculado à substituição tributária que compõe o campo “VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, conforme previsão das legislações das UF.
Campo 17 (VL_UNIT_ICMS_ST_CONV_COMPL) – Preenchimento: Nos casos de complemento, informar o valor
unitário de ICMS correspondente à diferença entre o valor unitário de ICMS na operação (campo
Página 87 de 301

--- Página 88 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
“VL_UNIT_ICMS_NA_OPERACAO_CONV”) e o valor de ICMS (op. própria + ST) por unidade do item no estoque,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, conforme previsão das legislações das UFs.
...
CST_ICMS, CFOP, e alíquota do ICMS.
10 VL_RED_BC Valor não tributado em função da redução N - 02 O O
...
2 VL_FCP_OP Valor do Fundo de Combate à Pobreza (FCP) N - 02 OC OC
vinculado à operação própria, na combinação de
CST_ICMS, CFOP e alíquota do ICMS
3 VL_FCP_ST Valor do Fundo de Combate à Pobreza (FCP) N - 02 OC OC
vinculado à operação de substituição tributária,
na combinação de CST_ICMS, CFOP e alíquota
do ICMS.
4 VL_FCP_RET Valor relativo ao Fundo de Combate à Pobreza N - 02 OC OC
...
02 COD_OBS Código da observação do lançamento fiscal C 006 - O O
(campo 02 do Registro 0460)
03 TXT_COMPL Descrição complementar do código de C - - OC OC
Página 90 de 301
...
02 COD_AJ Código do ajustes/benefício/incentivo, C 010* - O O
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
03 DESCR_COMPL Descrição complementar do ajuste do C - - OC OC
_AJ documento fiscal
...
02 CST_ICMS Código da Situação Tributária, N 003* - apresentar O
conforme a Tabela indicada no
item 4.3.1
03 CFOP Código Fiscal de Operação e N 004* - O
Prestação
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
05 VL_OPR Valor total acumulado das N - 02 O
operações correspondentes à
combinação de CST_ICMS,
CFOP e alíquota do ICMS,
incluídas as despesas acessórias e
acréscimos.
06 VL_BC_ICMS Valor acumulado da base de N - 02 O
...
combinação de CST_ICMS,
CFOP, e alíquota do ICMS.
07 VL_ICMS Valor acumulado do ICMS, N - 02 O
referente à combinação de
CST_ICMS, CFOP e alíquota do
ICMS.
08 VL_RED_BC Valor não tributado em função da N - 02 O
redução da base de cálculo do
ICMS, referente à combinação de
CST_ICMS, CFOP, e alíquota do
ICMS.
09 COD_OBS Código da observação do C 006 - OC
...
02 COD_ITEM Código do item (campo 02 do Registro C 060 - apresentar O
0200)
03 QTD Quantidade acumulada do item N - 03 O
04 UNID Unidade do item (Campo 02 do registro C 006 - O
0190)
05 VL_ITEM Valor acumulado do item N - 02 O
06 VL_DESC Valor do desconto acumulado N - 02 OC
07 VL_BC_ICMS Valor acumulado da base de cálculo do N - 02 OC
ICMS
...
apresentar
02 IND_REST_COMPL Código do motivo da restituição ou N 005* - O
complementação conforme Tabela 5.7
03 QUANT_CONV Quantidade do item N - 06 O
04 UNID Unidade adotada para informar o campo O
QUANT_CONV.
05 VL_UNIT_CONV Valor unitário da mercadoria, considerando a N - 06 O
unidade utilizada para informar o campo
“QUANT_CONV”.
06 VL_UNIT_ICMS_NA Valor unitário para o ICMS na operação, caso não N - 06 OC
_OPERACAO_CONV houvesse a ST, considerando unidade utilizada
para informar o campo “QUANT_CONV”.
07 VL_UNIT_ICMS_OP_ Valor unitário do ICMS que o contribuinte teria se N - 06 OC
CONV creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
comum de tributação, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”
08 VL_UNIT_BC_ICMS_ Valor médio unitário da Base de Cálculo do N - 06 OC
ST_ESTOQUE_CON ICMS/ST das mercadorias em estoque,
V considerando unidade utilizada para informar o
campo “QUANT_CONV”.
09 VL_UNIT_ICMS_ST_ Valor médio unitário do ICMS/ST, incluindo FCP N - 06 OC
ESTOQUE_CONV ST, das mercadorias em estoque, considerando
unidade utilizada para informar o campo
“QUANT_CONV”.
10 VL_UNIT_FCP_ICMS Valor médio unitário do ICMS/ST, incluindo FCP N - 06 OC
_ST_ESTOQUE_CON ST, das mercadorias em estoque, considerando
V unidade utilizada para informar o campo
“QUANT_CONV”.
...
conforme a legislação de cada UF, considerando a
unidade utilizada para informar o campo
“QUANT_CONV”.
Página 95 de 301
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
12 VL_UNIT_FCP_ST_C Valor unitário correspondente à parcela de ICMS N - 06 OC
ONV_REST FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para informar o
campo “QUANT_CONV”.
13 VL_UNIT_ICMS_ST_ Valor unitário do complemento do ICMS, N - 06 OC
CONV_COMPL incluindo FCP ST, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”.
14 VL_UNIT_FCP_ST_C Valor unitário correspondente à parcela de ICMS N - 06 OC
ONV_COMPL FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMPL”,
considerando unidade utilizada para informar o
campo “QUANT_CONV”.
Observação:
Nível hierárquico - 5
Ocorrência 1:1
Campo 01 (REG) - Valor Válido: [C330]
Campo 02 (IND_REST_COMPL) - Validação: o valor informado deve estar de acordo com a tabela 5.7 publicada pela UF
do informante do arquivo. Se o terceiro caractere do código preenchido no campo “IND_REST_COMPL” for:
a) igual a 0, os campos 06 a 14 não devem ser preenchidos
b) igual a 1, os campos 06, 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 07, 13 e 14 não devem ser
preenchidos
c) igual a 2, os campos 07, 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 06, 13 e 14 não devem ser
preenchidos
d) igual a 3, os campos 06, 08, 09, 10, 13 e 14 devem ser preenchidos e os campos 07, 11 e 12 não devem ser
preenchidos
Campo 03 (QUANT_CONV) – Preenchimento: Quantidade do item convertida na unidade de controle de estoque
informada no registro 0200 ou a unidade de comercialização, a critério de cada UF.
Validação: o valor informado no campo deve ser maior que “0” (zero).
...
alíquota interna (incluindo FCP) da mercadoria pelo valor correspondente à operação de saída que seria tributada se não
houvesse ST, considerando unidade utilizada para informar o campo “QUANT_CONV”.
Campo 07 (VL_UNIT_ICMS_OP_CONV) – Preenchimento: Nos casos de direito a crédito do imposto pela não ocorrência
do ato gerador presumido e desfazimento da ST, corresponde ao valor do ICMS da operação própria do sujeito passivo por
substituição do qual a mercadoria tenha sido recebida diretamente ou o valor do ICMS que seria atribuído à operação própria
do contribuinte substituído do qual a mercadoria tenha sido recebida, caso estivesse submetida ao regime comum de
tributação, calculado conforme a legislação de cada UF, considerando unidade utilizada para informar o campo
“QUANT_CONV”.
Campo 08 (VL_UNIT_BC_ICMS_ST_ESTOQUE_CONV) -: Preenchimento: Informar o valor médio unitário da Base de
Cálculo do ICMS/ST retido por substituição tributária que tenha sido recolhido pelo próprio informante ou a título de
reembolso que tenha sido suportado por ele das mercadorias em estoque. O período para o cálculo do valor médio deve
atender à legislação de cada UF. Ex. diário, mensal etc.
Página 96 de 301
...
Campo 11 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento:
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido, informar o valor unitário
de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por unidade do item no estoque,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor unitário de ICMS correspondente
ao campo 06 “VL_UNIT_ICMS_OP_CONV_REST”, conforme previsão das legislações das UFs.
b) Nos casos de direito ao crédito do imposto, calculada com base no valor de saída da mercadoria inferior ao valor
da BC/ST, informar o valor unitário de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por
unidade do item no estoque, considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor
unitário de ICMS na operação correspondente ao campo 05 “VL_UNIT_ICMS_NA_OPERACAO_CONV”, conforme
previsão das legislações das UFs.
Campo 12 (VL_UNIT_FCP_ST_CONV_REST) – Preenchimento: Informar o valor unitário do Fundo de Combate à
Pobreza (FCP) vinculado à substituição tributária que compõe o campo “ VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, conforme previsão das legislações das UF.
Campo 13 (VL_UNIT_ICMS_ST_CONV_COMPL) – Preenchimento: Nos casos de complemento, informar o valor
unitário de ICMS correspondente à diferença entre o valor unitário de ICMS na operação (campo
“VL_UNIT_ICMS_NA_OPERACAO_CONV”) e o valor de ICMS (op. própria + ST) por unidade do item no estoque,
considerando a unidade utilizada para informar o campo “QUANT_CONV”, conforme previsão das legislações das UFs.
...
Número sequencial do item no apresentar O
02 NUM_ITEM N 003 -
documento fiscal
Código do Item (campo 02 do registro O
03 COD_ITEM C 060 -
0200)
04 QTD Quantidade do item N - 3 O
Unidade do item (campo 02 do O
05 UNID C 006 -
registro 0190)
...
apresentar
02 IND_REST_CO Código do motivo da restituição ou complementação N 005* - O
MPL conforme Tabela 5.7
03 QUANT_CONV Quantidade do item N - 06 O
04 UNID Unidade adotada para informar o campo O
QUANT_CONV.
05 VL_UNIT_CON Valor unitário da mercadoria, considerando a unidade N - 06 O
V utilizada para informar o campo “QUANT_CONV”.
06 VL_UNIT_ICMS Valor unitário para o ICMS na operação, caso não N - 06 OC
_NA_OPERACA houvesse a ST, considerando unidade utilizada para
O_CONV informar o campo “QUANT_CONV”.
Página 98 de 301

--- Página 99 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
07 VL_UNIT_ICMS Valor unitário do ICMS que o contribuinte teria se N - 06 OC
_OP_CONV creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
comum de tributação, calculado conforme a legislação
de cada UF, considerando a unidade utilizada para
informar o campo “QUANT_CONV”
08 VL_UNIT_BC_I Valor médio unitário da Base de Cálculo do ICMS/ST N - 06 OC
CMS_ST_ESTO das mercadorias em estoque, considerando unidade
QUE_CONV utilizada para informar o campo “QUANT_CONV”.
09 VL_UNIT_ICMS Valor médio unitário do ICMS/ST, incluindo FCP ST, N - 06 OC
_ST_ESTOQUE_ das mercadorias em estoque, considerando unidade
CONV utilizada para informar o campo “QUANT_CONV”.
10 VL_UNIT_FCP_ Valor médio unitário do FCP ST agregado ao ICMS N - 06 OC
ICMS_ST_ESTO das mercadorias em estoque, considerando unidade
QUE_CONV utilizada para informar o campo “QUANT_CONV”.
11 VL_UNIT_ICMS Valor unitário do total do ICMS/ST, incluindo FCP N - 06 OC
_ST_CONV_RE ST, a ser restituído/ressarcido, calculado conforme a
ST legislação de cada UF, considerando a unidade
utilizada para informar o campo “QUANT_CONV”.
12 VL_UNIT_FCP_ Valor unitário correspondente à parcela de ICMS FCP N - 06 OC
ST_CONV_RES ST que compõe o campo
T “VL_UNIT_ICMS_ST_CONV_REST”, considerando
a unidade utilizada para informar o campo
“QUANT_CONV”.
13 VL_UNIT_ICMS Valor unitário do complemento do ICMS, incluindo N - 06 OC
_ST_CONV_CO FCP ST, considerando a unidade utilizada para
MPL informar o campo “QUANT_CONV”.
14 VL_UNIT_FCP_ Valor unitário correspondente à parcela de ICMS FCP N - 06 OC
ST_CONV_CO ST que compõe o campo
MPL “VL_UNIT_ICMS_ST_CONV_COMPL”,
...
02 DT_DOC Data do movimento a que se refere a N 008* - Apresentar O
Redução Z
03 CRO Posição do Contador de Reinício de N 003 - O
Operação
04 CRZ Posição do Contador de Redução Z N 006 - O
05 NUM_COO_FIN Número do Contador de Ordem de N 009 - O
Operação do último documento emitido
no dia. (Número do COO na Redução
Z)
...
a “0” (zero), não devem ser apresentados registros filhos e o registro C490.
...
02 COD_TOT_PAR Código do totalizador, conforme C 007 - apresentar O
Tabela 4.4.6
03 VLR_ACUM_TOT Valor acumulado no totalizador, N - 02 O
relativo à respectiva Redução Z.
04 NR_TOT Número do totalizador quando N 002 - OC
ocorrer mais de uma situação com a
mesma carga tributária efetiva.
05 DESCR_NR_TOT Descrição da situação tributária C - - OC
relativa ao totalizador parcial,
quando houver mais de um com a
mesma carga tributária efetiva.
Observações:
Nível hierárquico - 4
Ocorrência - 1:N
...
à alíquota informada no campo ALIQ_ICMS do registro C490. Caso o equipamento ECF seja autorizado a emitir cupom
fiscal com serviço tributado pelo município (ISS), os totalizadores desse serviço também deverão ser informados nesse
campo cujo conteúdo será Snnnn ou xxSnnnn, onde "nnnn" representa a carga tributária efetiva do imposto com duas casas
...
unidade utilizada para informar o campo
“QUANT_CONV”.
06 VL_UNIT_ICMS_N Valor unitário para o ICMS na operação, caso não N - 06 OC
A_OPERACAO_CO houvesse a ST, considerando unidade utilizada para
NV informar o campo “QUANT_CONV”.
07 VL_UNIT_ICMS_O Valor unitário do ICMS que o contribuinte teria se N - 06 OC
P_CONV creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
comum de tributação, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo “QUANT_CONV”
08 VL_UNIT_BC_ICM Valor médio unitário da Base de Cálculo do N - 06 OC
S_ST_ESTOQUE_C ICMS/ST das mercadorias em estoque,
ONV considerando unidade utilizada para informar o
campo “QUANT_CONV”.
09 VL_UNIT_ICMS_S Valor médio unitário do ICMS/ST, incluindo FCP N - 06 OC
T_ESTOQUE_CON ST, das mercadorias em estoque, considerando
V unidade utilizada para informar o campo
“QUANT_CONV”.
10 VL_UNIT_FCP_IC Valor médio unitário do FCP ST agregado ao N - 06 OC
MS_ST_ESTOQUE_ ICMS das mercadorias em estoque, considerando
CONV unidade utilizada para informar o campo
“QUANT_CONV”.
11 VL_UNIT_ICMS_S Valor unitário do total do ICMS/ST, incluindo FCP N - 06 OC
T_CONV_REST ST, a ser restituído/ressarcido, calculado conforme
a legislação de cada UF, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”.
12 VL_UNIT_FCP_ST_ Valor unitário correspondente à parcela de ICMS N - 06 OC
CONV_REST FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para informar o
campo “QUANT_CONV”.
13 VL_UNIT_ICMS_S Valor unitário do complemento do ICMS, incluindo N - 06 OC
T_CONV_COMPL FCP ST, considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
14 VL_UNIT_FCP_ST_ Valor unitário correspondente à parcela de ICMS N - 06 OC
CONV_COMPL FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMPL”,
considerando unidade utilizada para informar o
campo “QUANT_CONV”.
15 CST_ICMS Código da Situação Tributária referente ao ICMS N 003* - O
...
Campo 02 (IND_REST_COMPL) - Validação: o valor informado deve estar de acordo com a tabela 5.7 publicada pela UF
do informante do arquivo.
Se o terceiro caractere do código preenchido no campo “IND_REST_COMPL” for:
a) igual a 0, os campos 06 a 14 não devem ser preenchidos
b) igual a 1, os campos 06, 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 07, 13 e 14 não devem ser
preenchidos
c) igual a 2, os campos 07, 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 06, 13 e 14 não devem ser
...
ICMS que tenha sido informado no campo “VL_UNIT_ICMS_ST_ESTOQUE_CONV”.
Campo 11 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento:
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido, informar o valor unitário de
ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por unidade do item no estoque, considerando
a unidade utilizada para informar o campo “QUANT_CONV”, e o valor unitário de ICMS correspondente ao campo 06
“VL_UNIT_ICMS_OP_CONV_REST”, conforme previsão das legislações das UFs.
b) Nos casos de direito ao crédito do imposto, calculada com base no valor de saída da mercadoria inferior ao valor da
BC/ST, informar o valor unitário de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por
unidade do item no estoque, considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor
unitário de ICMS na operação correspondente ao campo 05 “VL_UNIT_ICMS_NA_OPERACAO_CONV”, conforme
...
02 COD_MOD Código do modelo do documento C 002* - apresentar O
fiscal, conforme a Tabela 4.1.1
03 COD_SIT Código da situação do documento N 002* - O
fiscal, conforme a Tabela 4.1.2
...
02 COD_ITEM Código do item (campo 02 do C 060 - apresentar O
Registro 0200)
03 QTD Quantidade do item N - 03 O
04 QTD_CANC Quantidade cancelada, no caso de N - 03 OC
cancelamento parcial de item
05 UNID Unidade do item (Campo 02 do C 006 - O
registro 0190)
06 VL_ITEM Valor total do item N - 02 O
07 CST_ICMS Código da Situação Tributária, N 003* - O
conforme a Tabela indicada no item
4.3.1.
08 CFOP Código Fiscal de Operação e N 004* - O
Prestação
09 ALIQ_ICMS Alíquota do ICMS – Carga tributária N 006 02 OC
efetiva em percentual
...
unidade utilizada para informar o campo
“QUANT_CONV”.
06 VL_UNIT_ICMS_NA_ Valor unitário para o ICMS na operação, caso N - 06 OC
OPERACAO_CONV não houvesse a ST, considerando unidade
utilizada para informar o campo
“QUANT_CONV”.
07 VL_UNIT_ICMS_OP_ Valor unitário do ICMS que o contribuinte teria N - 06 OC
CONV se creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
comum de tributação, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”
08 VL_UNIT_BC_ICMS_ Valor médio unitário da Base de Cálculo do N - 06 OC
ST_ESTOQUE_CONV ICMS/ST das mercadorias em estoque,
considerando unidade utilizada para informar o
campo “QUANT_CONV”.
Página 109 de 301
...
considerando unidade utilizada para informar o
campo “QUANT_CONV”.
10 VL_UNIT_FCP_ICMS Valor médio unitário do FCP ST agregado ao N - 06 OC
_ST_ESTOQUE_CON ICMS das mercadorias em estoque,
V considerando unidade utilizada para informar o
campo “QUANT_CONV”.
11 VL_UNIT_ICMS_ST_ Valor unitário do total do ICMS/ST, incluindo N - 06 OC
CONV_REST FCP ST, a ser restituído/ressarcido, calculado
conforme a legislação de cada UF, considerando
a unidade utilizada para informar o campo
“QUANT_CONV”.
...
ICMS/ST, neste campo deve ser informado o valor médio unitário total da parcela do ICMS/ST + a parcela do FCP vinculado
a este. O período para o cálculo do valor médio deve atender à legislação de cada UF. Ex. diário, mensal etc.
Campo 10 (VL_UNIT_FCP_ICMS_ST_ESTOQUE_CONV) -: Preenchimento: Informar o valor médio unitário da parcela
do FCP adicionado ao ICMS que tenha sido informado no campo “VL_UNIT_ICMS_ST_ESTOQUE_CONV”.
Campo 11 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento:
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido, informar o valor unitário de
ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por unidade do item no estoque, considerando
...
06 VL_BC_ICMS Valor acumulado da base de cálculo do N - 02 O
ICMS, referente à combinação de
CST_ICMS, CFOP, e alíquota do
ICMS.
...
combinação de CST_ICMS, CFOP e
alíquota do ICMS.
08 COD_OBS Código da observação do lançamento C 006 - OC
...
diferentes de 30, 40, 41, 50, e 60, então os valores dos campos VL_BC_ICMS, ALIQ_ICMS e VL_ICMS deverão ser
maiores que “0” (zero);c) se os dois últimos dígitos deste campo forem iguais a 51 ou 90, então os valores dos campos
...
05 QTD_CANC Quantidade cancelada acumulada, no N - 03 OC
caso de cancelamento parcial de item
06 UNID Unidade do item (Campo 02 do C 006 - O
registro 0190)
...
14 VL_NT Valor das saídas sob não-incidência ou N - 02 OC
não-tributadas pelo ICMS
15 VL_ICMS_ST Valor das saídas de mercadorias N - 02 OC
adquiridas com substituição tributária
do ICMS
Observações:
Nível hierárquico - 2
Ocorrência - vários
...
obrigados ao Convênio ICMS 115/03, pelos contribuintes do segmento de fornecimento de gás e, nas operações de entrada,
...
NUM_DOC e DT_DOC. A partir de 01/01/2020, se o campo COD_MOD for igual a ”66” o campo CHV_DOCe é
obrigatório. Demais campos deverão ser apresentados com conteúdo VAZIO “||”. Para esse documento não poderá ser
apresentado nenhum registro “filho”.
Exceção 2: Notas Fiscais de Energia Elétrica Eletrônicas (NF3e) de emissão própria: regra geral, devem ser apresentados
somente os registros C500 e C590.
Exceção 3: Notas Fiscais Complementares e Notas Fiscais Complementares Extemporâneas (campo COD_SIT igual a “06”
...
Exceção 5: Notas Fiscais de Energia Elétrica Eletrônicas (NF3e) de saída de emissão de terceiros: os casos de escrituração
em operações de saída de documentos fiscais eletrônicos emitidos por terceiros (como por ex. o consórcio constituído nos
termos do disposto nos arts. 278 e 279 da Lei nº 6.404, de 15 de dezembro de 1976), devem ser informados com o código de
situação do documento igual a “08 - Documento Fiscal emitido com base em Regime Especial ou Norma Específica”. O
PVA-EFD-ICMS/IPI exibirá a mensagem de advertência para esses documentos.
Obs.: Os documentos fiscais emitidos pelas filiais das empresas que possuam inscrição estadual única ou sejam autorizadas
pelos fiscos estaduais a centralizarem suas escriturações fiscais deverão ser informados como sendo de emissão própria e
código de situação igual a “00 – Documento regular”.
Validação do Registro: não podem ser informados dois ou mais registros com a mesma combinação de valores dos
...
05 COD_MOD Código do modelo do documento C 002* - O O
fiscal, conforme a Tabela 4.1.1
...
09 COD_CONS - Código de classe de consumo de C 002* - OC O
...
pelo ICMS
17 VL_TERC Valor total cobrado em nome de N - 02 OC OC
terceiros
18 VL_DA Valor total de despesas acessórias N - 02 OC OC
indicadas no documento fiscal
19 VL_BC_ICMS Valor acumulado da base de cálculo N - 02 OC OC
do ICMS
20 VL_ICMS Valor acumulado do ICMS N - 02 OC OC
21 VL_BC_ICMS_ST Valor acumulado da base de cálculo N - 02 OC OC
do ICMS substituição tributária
22 VL_ICMS_ST Valor acumulado do ICMS retido por N - 02 OC OC
substituição tributária
23 COD_INF Código da informação complementar C 006 - OC OC
do documento fiscal (campo 02 do
Registro 0450)
...
2 - Bifásico
3 - Trifásico
27 COD_GRUPO_TENSA Código de grupo de tensão: C 002* - OC OC
O 01 - A1 - Alta Tensão (230kV ou
mais)
...
13 - B4a - Iluminação Pública - rede
de distribuição
14 - B4b - Iluminação Pública - bulbo
de lâmpada
CHV_DOCe Chave da Nota Fiscal de Energia
28 Elétrica Eletrônica N 044* - OC OC
...
4.4.2 da Nota Técnica 2018.001, instituída pelo Ato COTEPE/ICMS nº 44/2018). Se o modelo do documento for 66, o
...
Validação: a informação é obrigatória nas operações de saídas, se COD_MOD igual a “06”. Se COD_MOD for “66”, o
campo não deve ser preenchido.
Campo 27 (COD_GRUPO_TENSAO) -
Valores válidos: [01, 02, 03, 04, 05, 06, 07, 08, 09, 10, 11, 12, 13, 14]
Validação: a informação é obrigatória nas operações de saídas quando COD_MOD for igual a “06”.
Se COD_MOD igual a “66”, o campo não deve ser preenchido.
...
NUM_DOC e SER com o número do documento e série contidos na chave da NF3e. Será também comparada a UF
codificada na chave do documento eletrônico com o campo UF informado no registro 0000.
...
informado.
Campo 30 (CHV_DOCe_REF) - Preenchimento: deve ser preenchido quando o campo COD_MOD for “66” e o campo
FIN_DOCe se referir a “2 – Substituição”. Deve ser informada a chave do documento substituído, se eletrônico. Nos demais
casos, não preencher.
Validação: será conferido o dígito verificador (DV) da chave do documento eletrônico.
...
02 NUM_ITEM Número sequencial do item no N 003 - apresentar O
documento fiscal
03 COD_ITEM Código do item (campo 02 do Registro C 060 - O
0200)
04 COD_CLASS Código de classificação do item de N 004* - OC
energia elétrica, conforme a Tabela
4.4.1
...
09 CST_ICMS Código da Situação Tributária, N 003* - O
conforme a Tabela indicada no item
4.3.1
...
14 VL_BC_ICMS_ST Valor da base de cálculo referente à N - 02 OC
substituição tributária
15 ALIQ_ST Alíquota do ICMS da substituição N 006 02 OC
tributária na unidade da federação de
destino
...
18 COD_PART Código do participante receptor da C 060 OC
receita, terceiro da operação (campo 02
do Registro 0150)
...
VL_ICMS dos registros C510 (itens), se existirem, que possuam a mesma combinação de CST, CFOP e Alíquota deste
registro.
Campo 08 (VL_BC_ICMS_ST) - Validação: o valor constante neste campo deve corresponder à soma dos valores do campo
VL_BC_ICMS_ST dos registros C510 (itens), se existirem, que possuam a mesma combinação de CST, CFOP e Alíquota
deste registro.
...
federativas.
Nº Campo Descrição Tipo Tam Dec Entr. Saídas
1 Texto fixo contendo "C591"
REG C 004 - O O
2 Valor do Fundo de Combate à Pobreza (FCP)
VL_FCP_OP vinculado à operação própria, na combinação de N - 02 OC OC
CST_ICMS, CFOP e alíquota do ICMS
3 Valor do Fundo de Combate à Pobreza (FCP)
VL_FCP_ST vinculado à operação de substituição tributária, na N - 02 OC OC
combinação de CST_ICMS, CFOP e alíquota do
ICMS.
Observações:
Nível hierárquico – 4
...
Este registro deve ser informado quando, em decorrência da legislação estadual, houver ajustes nos documentos
fiscais eletrônicos, informações sobre diferencial de alíquota, antecipação de imposto e outras situações. Estas informações
equivalem às observações que são lançadas na coluna “Observações” dos Livros Fiscais previstos no Convênio SN/70 –
SINIEF, art. 63, I a IV.
Sempre que existir um ajuste (lançamentos referentes aos impostos que têm o cálculo detalhado em Informações
Complementares da NF; ou aos impostos que estão definidos na legislação e não constam na NF; ou aos recolhimentos
antecipados dos impostos), deve, conforme dispuser a legislação estadual, ocorrer uma observação.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
Campo 02 (COD_OBS) – Preenchimento: as observações de lançamento devem ser informadas neste campo, exceto
quando a legislação estadual prever o preenchimento do campo COD_OBS do registro C590.
Validação: o código informado deve constar do registro 0460.
...
com a especificação do TERCEIRO CARACTERE do Código do Ajuste (Tabela 5.3 - Tabela de Ajustes e Valores
provenientes do Documento Fiscal).
Os valores que gerarem crédito ou débito de ICMS (ou seja, aqueles que não sejam simplesmente informativos)
serão somados na apuração, assim como os registros C590.
...
02 COD_AJ Código do ajustes/benefício/incentivo, C 010* - O O
conforme tabela indicada no item 5.3.
03 DESCR_COMPL_AJ Descrição complementar do ajuste do C - - OC OC
documento fiscal
Página 122 de 301
...
Campo 03 (DESCR_COMPL_AJ): Preenchimento: O contribuinte deverá fazer a descrição complementar de ajustes
(Tabela 5.3) sempre que informar códigos genéricos.
...
Campo 07 (VL_ICMS) - Preenchimento: valor do montante do ajuste do imposto. Para ajustes referentes a ICMS-ST, o
campo VL_ICMS deve conter o valor do ICMS-ST. Os dados que gerarem crédito ou débito (ou seja, aqueles que não são
simplesmente informativos) serão somados na apuração, assim como os registros C590.
Campo 08 (VL_OUTROS) - Preenchimento: preencher com outros valores, quando o código do ajuste for informativo,
conforme Tabela 5.3.
...
- Código de classe de consumo de
Fornecimento D´água – Tabela 4.4.2.
07 QTD_CONS Quantidade de documentos N - - O
...
16 VL_DA Valor acumulado das despesas N - 02 OC
acessórias
...
02 NUM_DOC_CANC Número do documento fiscal N 009 - apresentar O
cancelado
Observações:
Nível hierárquico - 3
Ocorrência - 1:N
...
02 COD_CLASS Código de classificação do item de N 004* - apresentar OC
energia elétrica, conforme Tabela 4.4.1
03 COD_ITEM Código do item (campo 02 do Registro C 060 - O
0200)
04 QTD Quantidade acumulada do item N - 03 O
...
08 CST_ICMS Código da Situação Tributária, N 003* - O
conforme a Tabela indicada no item
4.3.1
...
combinação de CST_ICMS, CFOP, e
alíquota do ICMS.
06 VL_BC_ICMS Parcela correspondente ao "Valor da base N - 2 O
de cálculo do ICMS" referente à
combinação CST_ICMS, CFOP e alíquota
do ICMS
07 VL_ICMS Parcela correspondente ao "Valor do N - 2 O
ICMS" referente à combinação
CST_ICMS, CFOP e alíquota do ICMS
...
tributária
11 COD_OBS Código da observação do lançamento C 006 - OC
fiscal (campo 02 do Registro 0460)
Observações:
Nível hierárquico - 3
Ocorrência - 1:N
...
Data de emissão inicial dos documentos / O
06 DT_DOC_INI N 008* -
Data inicial de vencimento da fatura
Data de emissão final dos documentos / O
07 DT_DOC_FIN N 008* -
Data final do vencimento da fatura
Nome do arquivo Mestre de Documento O
08 NOM_MEST C 033 -
Fiscal
Chave de codificação digital do arquivo O
...
alíquota do ICMS.
Parcela correspondente ao “Valor da base O
de cálculo do ICMS” referente à
06 VL_BC_ICMS N - 02
combinação CST_ICMS, CFOP, e alíquota
do ICMS
Parcela correspondente ao “Valor do O
07 VL_ICMS ICMS” referente à combinação N - 02
CST_ICMS, CFOP e alíquota do ICMS
VL_BC_ICMS_S Valor da base de cálculo do ICMS O
08 N - 02
T substituição tributária
Valor do ICMS retido por substituição O
09 VL_ICMS_ST N - 02
tributária
10 VL_RED_BC Valor não tributado em função da redução N - 02 O
da base de cálculo do ICMS, referente à
combinação de CST_ICMS, CFOP e
alíquota do ICMS..
...
02 UF Sigla da unidade da federação a que se refere a C 002* - apresentar O
retenção ST
...
02 COD_MOD Código do modelo do documento fiscal, C 002 - O
conforme a Tabela 4.1.1
...
quaisquer caracteres de separação, tais como: “.”, “/”, “-”.
Validação: o valor informado no campo deve ser menor ou igual ao valor do campo DT_FIN do registro 0000.
Campo 06 (VL_CFE) – Preenchimento: corresponde ao campo Valor total do CF-e-SAT, constante do leiaute do CF-e-
SAT.
...
apresent
ar
02 IND_REST_COMPL Código do motivo da restituição ou complementação N 005* - O
conforme Tabela 5.7
03 QUANT_CONV Quantidade do item N - 06 O
04 UNID Unidade adotada para informar o campo O
QUANT_CONV.
05 VL_UNIT_CONV Valor unitário da mercadoria, considerando a unidade N - 06 O
utilizada para informar o campo “QUANT_CONV”.
Página 132 de 301
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
06 VL_UNIT_ICMS_NA_ Valor unitário para o ICMS na operação, caso não N - 06 OC
OPERACAO_CONV houvesse a ST, considerando unidade utilizada para
informar o campo “QUANT_CONV”.
07 VL_UNIT_ICMS_OP_ Valor unitário do ICMS que o contribuinte teria se N - 06 OC
CONV creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
...
de cada UF, considerando a unidade utilizada para
informar o campo “QUANT_CONV”
08 VL_UNIT_BC_ICMS_ Valor médio unitário da Base de Cálculo do ICMS/ST N - 06 OC
ST_ESTOQUE_CONV das mercadorias em estoque, considerando unidade
utilizada para informar o campo “QUANT_CONV”.
09 VL_UNIT_ICMS_ST_ Valor médio unitário do ICMS/ST, incluindo FCP ST, N - 06 OC
ESTOQUE_CONV das mercadorias em estoque, considerando unidade
utilizada para informar o campo “QUANT_CONV”.
10 VL_UNIT_FCP_ICMS Valor médio unitário do FCP ST agregado ao ICMS N - 06 OC
_ST_ESTOQUE_CON das mercadorias em estoque, considerando unidade
V utilizada para informar o campo “QUANT_CONV”.
11 VL_UNIT_ICMS_ST_ Valor unitário do total do ICMS/ST, incluindo FCP ST, N - 06 OC
CONV_REST a ser restituído/ressarcido, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo “QUANT_CONV”.
12 VL_UNIT_FCP_ST_C Valor unitário correspondente à parcela de ICMS FCP N - 06 OC
ONV_REST ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”, considerando
a unidade utilizada para informar o campo
“QUANT_CONV”.
13 VL_UNIT_ICMS_ST_ Valor unitário do complemento do ICMS, incluindo N - 06 OC
CONV_COMPL FCP ST, considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
14 VL_UNIT_FCP_ST_C Valor unitário correspondente à parcela de ICMS FCP N - 06 OC
ONV_COMPL ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMPL”,
considerando unidade utilizada para informar o campo
“QUANT_CONV”.
Observação:
...
agrupamento de itens
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
05 VL_OPR “Valor total do CF-e” na combinação de N - 02
CST_ICMS, CFOP e alíquota do ICMS,
O
correspondente ao somatório do valor líquido dos Não
itens. apresentar
06 VL_BC_ICMS Valor acumulado da base de cálculo do ICMS, N - 2
referente à combinação de CST_ICMS, CFOP, e O
alíquota do ICMS.
07 VL_ICMS Parcela correspondente ao “Valor do ICMS” N - 02
referente à combinação de CST_ICMS, CFOP e O
alíquota do ICMS.
08 COD_OBS Código da observação do lançamento fiscal C 006 -
OC
(campo 02 do registro 0460)
Observações:
Nível hierárquico: 3
...
02 COD_MOD Código do modelo do documento fiscal, conforme a Tabela C 002 - Apresentar O
4.1.1
...
REGISTRO C870: ITENS DO RESUMO DIÁRIO DOS DOCUMENTOS (CF-E-SAT) (CÓDIGO
59)
A obrigatoriedade e a forma de escrituração deste registro serão definidas pela UF de domicílio do contribuinte
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
04 UNID Unidade do item (Campo 02 do registro 0190) C 006 - O
05 CFOP Código Fiscal de Operação e Prestação N 004* - O
06 CST_ICMS Código da Situação Tributária referente ao ICMS N 003* - O
Observação:
Nível hierárquico - 3
Ocorrência 1:N
Campo 01 (REG) - Valor Válido: [C870]
Campo 02 (COD_ITEM) - Validação: o valor informado neste campo deve existir no registro 0200 e constantes do
documento fiscal.
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
Campo 04 (UNID) - Preenchimento: informar a unidade de medida de comercialização do item utilizada no documento
fiscal. Caso a unidade de medida do documento fiscal seja diferente da unidade de medida de controle de estoque informada
no Registro 0200, deverá ser informado no Registro 0220 o fator de conversão entre as unidades de medida.
Validação: o valor informado neste campo deve existir no registro 0190.
Campo 05 (CFOP) - Preenchimento: informar o código de operação que consta no documento fiscal. O código CFOP deve
iniciar-se por “5”.
Campo 06 (CST_ICMS) – Preenchimento: o campo deverá ser preenchido com o código da Situação Tributária
correspondente ao informado no documento fiscal.
Validação: o valor informado no campo deve existir na Tabela da Situação Tributária referenciada no item 4.3.1, da nota
técnica 2018.001.
...
02 IND_REST_COMPL Código do motivo da restituição ou N 005* - apresentar O
complementação conforme Tabela 5.7
03 QUANT_CONV Quantidade do item N - 06 O
04 UNID Unidade adotada para informar o campo O
QUANT_CONV.
...
unidade utilizada para informar o campo
“QUANT_CONV”.
06 VL_UNIT_ICMS_N Valor unitário para o ICMS na operação, caso não N - 03 OC
A_OPERACAO_CO houvesse a ST, considerando unidade utilizada para
NV informar o campo “QUANT_CONV”.
07 VL_UNIT_ICMS_OP Valor unitário do ICMS que o contribuinte teria se N - 03 OC
_CONV creditado referente à operação de entrada da
mercadoria, caso estivesse submetida ao regime
comum de tributação, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo “QUANT_CONV”
08 VL_UNIT_BC_ICMS Valor médio unitário da Base de Cálculo do N - 03 OC
_ST_ESTOQUE_CO ICMS/ST das mercadorias em estoque,
NV considerando unidade utilizada para informar o
campo “QUANT_CONV”.
09 VL_UNIT_ICMS_ST Valor médio unitário do ICMS/ST, incluindo FCP N - 03 OC
_ESTOQUE_CONV ST, das mercadorias em estoque, considerando
unidade utilizada para informar o campo
“QUANT_CONV”.
10 VL_UNIT_FCP_ICM Valor médio unitário do FCP ST agregado ao N - 03 OC
S_ST_ESTOQUE_C ICMS das mercadorias em estoque, considerando
ONV unidade utilizada para informar o campo
“QUANT_CONV”.
11 VL_UNIT_ICMS_ST Valor unitário do total do ICMS/ST, incluindo FCP N - 03 OC
_CONV_REST ST, a ser restituído/ressarcido, calculado conforme a
legislação de cada UF, considerando a unidade
utilizada para informar o campo “QUANT_CONV”.
12 VL_UNIT_FCP_ST_ Valor unitário correspondente à parcela de ICMS N - 03 OC
CONV_REST FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para informar o
campo “QUANT_CONV”.
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
13 VL_UNIT_ICMS_ST Valor unitário do complemento do ICMS, incluindo N - 03 OC
_CONV_COMPL FCP ST, considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
14 VL_UNIT_FCP_ST_ Valor unitário correspondente à parcela de ICMS N - 03 OC
CONV_COMPL FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMPL”,
considerando unidade utilizada para informar o
campo “QUANT_CONV”.
...
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido, informar o valor unitário de
ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por unidade do item no estoque, considerando
a unidade utilizada para informar o campo “QUANT_CONV”, e o valor unitário de ICMS correspondente ao campo
“VL_UNIT_ICMS_OP_CONV_REST”, conforme previsão das legislações das UFs.
b) Nos casos de direito ao crédito do imposto, calculada com base no valor de saída da mercadoria inferior ao valor da
BC/ST, informar o valor unitário de ICMS correspondente à diferença entre o valor de ICMS (op. própria + ST) por
unidade do item no estoque, considerando a unidade utilizada para informar o campo “QUANT_CONV”, e o valor
...
02 CST_ICMS Código da Situação Tributária, conforme a Tabela indicada N 003 - O
no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação do agrupamento de N 004 - O
itens
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
05 VL_OPR “Valor total do CF-e” na combinação de CST_ICMS, CFOP N - 02 O
e ALÍQUOTA DO ICMS, correspondente ao somatório do Não
valor líquido dos itens. apresentar
06 VL_BC_ICMS Valor acumulado da base de cálculo do ICMS, referente à N - 2 O
combinação de CST_ICMS, CFOP e ALÍQUOTA DO
ICMS.
