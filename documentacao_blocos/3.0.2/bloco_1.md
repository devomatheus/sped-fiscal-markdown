...
02 VL_CREDITO_ICMS_ Informar o valor total do ICMS operação própria que o N - 02 O
OP informante tem direito ao crédito, na forma prevista na
legislação, referente às hipóteses de restituição em que
há previsão deste crédito.
03 VL_ICMS_ST_REST Informar o valor total do ICMS/ST que o informante N - 02 O
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
05 VL_ICMS_ST_COMPL Informar o valor total do débito referente ao N - 02 O
...
02 COD_MOT_REST_COMPL Código do motivo da restituição ou complementação N 005* 02 O
conforme Tabela 5.7
...
“COD_MOT_REST_COMPL”
04 VL_ICMS_ST_REST_MOT Informar o valor total do ICMS/ST que o informante tem N - 02 O
direito ao crédito, na forma prevista na legislação,
referente às hipóteses de restituição em que há previsão
...
03 Valor das prestações passageiros/cargas (Não 02 O
VL_PASS N -
Tributado)
...
10 Valor da diferença a ser levada a estorno de crédito 02 O
VL_DIF N -
na apuração (6 - 8)
Observações:
Nível hierárquico - 2
...
7 – APURAÇÃO 5;
8 – APURAÇÃO 6.
03 DESCR_COMPL_OUT_APU Descrição complementar de Outra Apuração C - - O
R do ICMS
...
dígito do COD_AJ, campo 02, seja 6, ou valor maior que “zero” no campo 08-
VL_SLD_CREDOR_ANT_OA do registro 1920).
...
dígito do COD_AJ, campo 02, seja 8, ou valor maior que “zero” no campo 08-
VL_SLD_CREDOR_ANT_OA do registro 1920).
...
02 IND_AP Indicador da sub-apuração por tipo de benefício N 002* - O
...
07 G1_05 Saldo devedor do ICMS antes das deduções do N - 02 O
incentivo
08 G1_06 Saldo devedor do ICMS relativo à faixa incentivada de N - 02 O
PI
09 G1_07 Crédito presumido nas saídas incentivadas de PI para N - 02 O
fora do Nordeste
10 G1_08 Saldo devedor relativo à faixa incentivada de PI após o N - 02 O
...
02 IND_AP Indicador da sub-apuração por tipo de benefício (conforme N 002* - O
tabela 4.7.1)
...
02 ALIQ_IMP_ Alíquota incidente sobre as importações-base N - 02 O
BASE
Página 265 de 301
...
09 G4_07 Saldo devedor do ICMS antes das deduções do N - 02 O
...
12 G4_10 Dedução de incentivo da Central de Distribuição N - 02 O
(entradas/saídas)
