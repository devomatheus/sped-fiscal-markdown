...
1 GIAF 1 - Guia de informação e apuração de incentivos fiscais e financeiros: 1960 2 1:N
indústria (crédito presumido)
1 GIAF 3 - Guia de informação e apuração de incentivos fiscais e financeiros: 1970 2 1:N
importação (diferimento na entrada e crédito presumido na saída subsequente)
1 GIAF 3 - Guia de informação e apuração de incentivos fiscais e financeiros: 1975 3 1:4
importação (saídas internas por faixa de alíquota)
1 GIAF 4 - Guia de informação e apuração de incentivos fiscais e financeiros: central 1980 2 1
de distribuição (entradas/saídas)
...
Obs.: Para as SEFAZ que exigem a informação do hash do arquivo, esse refere-se ao hash do arquivo
RETIFICADOR assinado. Para obtê-lo utilizar a opção “Dados da Escrituração” da aba Relatórios, o hash está identificado
com o nome “ID do Arquivo Assinado (hash)”, contendo 32 caracteres.
...
02 CLAS_ESTAB_ Informar a classificação do estabelecimento N 002 - O
IND conforme tabela 4.5.5
Página 26 de 301
...
substituído ou unidade de federação do consumidor
final não contribuinte - ICMS Destino EC 87/15.
03 IE_ST Inscrição Estadual do contribuinte substituto na C 014 - O
unidade da federação do contribuinte substituído ou
unidade de federação do consumidor final não
...
05 CNPJ Número de inscrição do escritório de contabilidade N 014* - OC
no CNPJ, se houver.
...
03 NR_CAMPO Número do campo alterado (campos 03 a 13, C 002 - O
exceto 07)
...
02 DESCR_ANT_IT Descrição anterior do item C - - OC
EM
...
02 COD_COMB Código do produto, conforme tabela publicada C - - O
pela ANP
Observações:
Nível hierárquico - 3
Ocorrência - 1:1
...
item 3.2.1 da Nota Técnica 2018.001 (Ato COTEPE/ICMS nº 44/2018).
...
02 COD_ITEM_COMP Código do item componente/insumo (campo 02 C 60 - O
do Registro 0200)
...
(multiplicar) a unidade a ser convertida na
unidade adotada no inventário.
Observações:
Nível hierárquico - 3
Ocorrência - 1:N
...
03 TXT Descrição da observação vinculada ao C - - O
lançamento fiscal
Observações:
Nível hierárquico - 2
Ocorrência –vários (por arquivo)
...
Nº Campo Descrição Tip Tam Dec Obrig
o
...
Nº Campo Descrição Tipo Tam Dec Ent Saída
r
...
Atualização: 21 de maio de 2019
1 - Terceiros
04 COD_PART Código do participante (campo 02 C 060 - O OC
do Registro 0150):
- do prestador, no caso de declarante
...
11 COD_MUN_ Código do município onde o serviço foi C 007* - O O
SERV prestado, conforme a tabela IBGE.
12 VL_CONT Valor contábil (valor total do N - 02 O O
documento)
13 VL_MAT_T Valor do material fornecido por terceiros N - 02 O O
ERC na prestação do serviço
14 VL_SUB Valor da subempreitada N - 02 O O
15 VL_ISNT_IS Valor das operações isentas ou não- N - 02 O O
S tributadas pelo ISS
16 VL_DED_B Valor da dedução da base de cálculo N - 02 O O
C
17 VL_BC_ISS Valor da base de cálculo do ISS N - 02 O O
18 VL_BC_ISS Valor da base de cálculo de retenção do N - 02 O O
_RT ISS
19 VL_ISS_RT Valor do ISS retido pelo tomador N - 02 O O
20 VL_ ISS Valor do ISS destacado N - 02 O O
21 COD_INF_O Código da observação do lançamento C 060 - OC OC
BS fiscal (campo 02 do Registro 0460)
Observações:
Nível hierárquico - 2
Ocorrência – vários (por arquivo)
...
Nº Campo Descrição Tipo Tam Dec Ent Saídas
r
Página 43 de 301
...
03 VL_BC_ISS_ Parcela correspondente ao “Valor da N - 02 O O
P base de cálculo do ISS” referente à
combinação da alíquota e item da
lista
04 ALIQ_ISS Alíquota do ISS N - 02 O O
05 VL_ISS_P Parcela correspondente ao “Valor do N - 02 O O
ISS” referente à combinação da
alíquota e item da lista
06 VL_ISNT_ISS Parcela correspondente ao “Valor das N - 02 O O
_P operações isentas ou não-tributadas
pelo ISS” referente à combinação da
alíquota e item da lista
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
1 REG Texto fixo contendo “B030” C 004* - Não O
informar
02 COD_MOD Código do modelo do documento fiscal, C 002* - O
conforme a Tabela 4.1.3
03 SER Série do documento fiscal C 003 - OC
04 NUM_DOC_INI Número do primeiro documento fiscal N 009 - O
emitido no dia
05 NUM_DOC_FI Número do último documento fiscal N 009 - O
N emitido no dia
06 DT_DOC Data da emissão dos documentos fiscais N 008* - O
07 QTD_CANC Quantidade de documentos cancelados N - - O
08 VL_CONT Valor contábil (valor total acumulado dos N - 02 O
documentos)
09 VL_ISNT_ISS Valor acumulado das operações isentas N - 02 O
ou não-tributadas pelo ISS
10 VL_BC_ISS Valor acumulado da base de cálculo do N - 02 O
ISS
11 VL_ ISS Valor acumulado do ISS destacado N - 02 O
12 COD_INF_OBS Código da observação do lançamento C 060 - OC
...
com a mesma combinação de valores dos campos: ALIQ_ISS e COD_SERV.
Nº Campo Descrição Tip Tam Dec Entr. Saídas
o
01 REG Texto fixo contendo “B035” C 004 - Não O
* informar
02 VL_CONT_P Parcela correspondente ao “Valor N - 02 O
Contábil” referente à combinação
da alíquota e item da lista
03 VL_BC_ISS_P Parcela correspondente ao “Valor N - 02 O
da base de cálculo do ISS”
referente à combinação da
alíquota e item da lista
04 ALIQ_ISS Alíquota do ISS N - 02 O
05 VL_ISS_P Parcela correspondente ao “Valor N - 02 O
do ISS” referente à combinação da
alíquota e item da lista
06 VL_ISNT_ISS_ Parcela correspondente ao “Valor N - 02 O
P das operações isentas ou não-
...
06 COD_SERV Item da lista de serviços, conforme Tabela N 004* - O
4.6.3.
...
02 VL_CONT Totalização do Valor Contábil das N - 02 Informar O
...
alíquota e item da lista
04 ALIQ_ISS Alíquota do ISS N - 02 O
05 VL_ISNT_IS Totalização do valor das operações N - 02 O
S isentas ou não-tributadas pelo ISS
...
N Campo Descrição Tipo Tam Dec Entr Saídas
º
...
0 - Aquisição;
1 - Prestação
03 COD_PART Código do participante (campo 02 do C - - O O
Registro 0150):
...
05 VL_BC_ISS_RT Totalização do Valor da base de N - 02 O O
...
04 NUM_PRO Número do processo ao qual o ajuste C - - OC OC
C está vinculado, se houver
05 IND_PRO Indicador da origem do processo: C 001* - OC OC
C 0 - Sefin;
1 - Justiça Federal;
2 - Justiça Estadual;
9 - Outros
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
06 PROC Descrição do processo que embasou o C - - OC OC
lançamento
07 COD_INF_ Código da observação do C 060 - O O
OBS lançamento fiscal
(campo 02 do Registro 0460)
08 IND_OBR Indicador da obrigação onde será C 001* - O O
aplicada a dedução:
0 - ISS Próprio;
...
serviço do período
03 VL_MAT_TE B - Valor total do material fornecido por N - 02 O
RC terceiros na prestação do serviço
04 VL_MAT_PR C - Valor do material próprio utilizado N - 02 O
OP na prestação do serviço
...
09 VL_BC_ISS_ H - Valor total da base de cálculo de N - 02 O
RT retenção do ISS referente às prestações
do declarante.
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
11 VL_ISS_RT J - Valor total do ISS retido pelo N - 02 O
tomador nas prestações do declarante
...
(tomador)
15 VL_ N - Valor do ISS próprio a recolher pela N - 02 O
ISS_REC_UNI Sociedade Uniprofissional
Observações:
Nível hierárquico – 2
Ocorrência – um (por arquivo)
...
02 VL_REC Valor mensal das receitas auferidas pela N - 02 O
...
0 - Sócio
1 - Não sócio
05 CPF Número de inscrição do profissional no N 011* - O
CPF.
