...
conforme definido no Manual de Integração do CT-e
ou do Bilhete de Passagem Eletrônico conforme
definido no Manual de Integração do BP-e
14 CHV_CTE_RE Chave do Bilhete de Passagem Eletrônico substituído N 044* - OC OC
F
...
24 COD_MUN_O Código do município de origem do serviço, N 007* - OC OC
RIG conforme a tabela IBGE (Preencher com 9999999, se
Exterior)
25 COD_MUN_D Código do município de destino, conforme a tabela N 007* - OC OC
EST IBGE (Preencher com 9999999, se Exterior)
Observações:
Nível hierárquico - 2
...
informar a chave do BP-e substituído.
...
02 VL_FCP_UF_ Valor total relativo ao Fundo de Combate à N - 02 O O
DEST Pobreza (FCP) da UF de destino
03 VL_ICMS_UF Valor total do ICMS Interestadual para a UF N - 02 O O
_DEST de destino
04 VL_ICMS_UF Valor total do ICMS Interestadual para a UF N - 02 O O
_REM do remetente
Observações:
Nível hierárquico - 3
Ocorrência - 1:1
...
02 COD_MUN_ORIG Código do município de origem do N 007* - apresentar O
serviço, conforme a tabela
IBGE(Preencher com 9999999, se
Exterior)
03 COD_MUN_DEST Código do município de destino, N 007* - O
...
02 COD_PART_CONS Código do participante (campo 02 do C 060 - apresentar OC
G Registro 0150):
...
conforme a tabela IBGE(Preencher com
9999999, se Exterior)
06 COD_MUN_DEST Código do município de destino, conforme N 007* - O
a tabela IBGE(Preencher com 9999999, se
Exterior)
...
conforme a tabela IBGE(Preencher com
9999999, se Exterior)
04 COD_MUN_DEST Código do município de destino, conforme N 007* - O
a tabela IBGE(Preencher com 9999999, se
Exterior)
...
06 VEIC_ID Identificação da embarcação (IRIM ou C - - OC
Registro CPP)
...
03 COD_MUN_DEST Código do município de destino, N 007* - O
conforme a tabela IBGE (Preencher
...
03 CNPJ_CPF_REM CNPJ ou CPF do remetente das mercadorias N 014 - OC
que constam na nota fiscal.
04 IE_REM Inscrição Estadual do remetente das C 014 - OC
...
Exterior)
06 CNPJ_CPF_DEST CNPJ ou CPF do destinatário das N 014 - OC
mercadorias que constam na nota fiscal.
...
5-Aéreo
9-Outros
Número do CNPJ ou CPF do local da OC
...
02 COD_MOD Código do modelo do documento fiscal, C 002* - apresentar OC
...
07 VL_MERC Valor das mercadorias constantes no N - 02 OC
documento fiscal
08 QTD_VOL Quantidade de volumes transportados N - - O
09 PESO_BRT Peso bruto dos volumes transportados (em N - 02 OC
kg)
10 PESO_LIQ Peso líquido dos volumes transportados N - 02 OC
(em kg)
Observações:
Nível hierárquico - 4
Ocorrência - 1:N
...
03 IND_EMIT Indicador do emitente do documento C 001* - O
fiscal:
0 - Emissão própria;
1 - Terceiros
04 CNPJ_CPF_EMIT CNPJ ou CPF do participante emitente N 014 - O
Página 152 de 301
...
Atualização: 21 de maio de 2019
do modal
05 UF_EMIT Sigla da unidade da federação do C 002* - O
participante emitente do modal
06 IE_EMIT Inscrição Estadual do participante C 014 - OC
emitente do modal
07 COD_MUN_ORIG Código do município de origem do N 007* - O
serviço, conforme a tabela
IBGE(Preencher com 9999999, se
Exterior)
08 CNPJ_CPF_TOM CNPJ/CPF do participante tomador do N 014 - O
serviço
09 UF_TOM Sigla da unidade da federação do C 002* - O
participante tomador do serviço
10 IE_TOM Inscrição Estadual do participante C 014 - OC
tomador do serviço
11 COD_MUN_DEST Código do município de destino, N 007* - O
conforme a tabela IBGE(Preencher com
9999999, se Exterior)
...
Código Fiscal de Operação e Prestação, O O
03 CFOP N 004* -
conforme a tabela indicada no item 4.2.2
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC OC
VL_OPR Valor da operação correspondente à O O
05 combinação de CST_ICMS, CFOP, e N - 02
alíquota do ICMS.
Parcela correspondente ao "Valor da base O O
de cálculo do ICMS" referente à
06 VL_BC_ICMS N - 02
combinação CST_ICMS, CFOP, e
alíquota do ICMS
Parcela correspondente ao "Valor do O O
07 VL_ICMS ICMS" referente à combinação N - 02
CST_ICMS, CFOP e alíquota do ICMS
08 VL_RED_BC Valor não tributado em função da redução N - 02 O O
da base de cálculo do ICMS, referente à
combinação de CST_ICMS, CFOP e
alíquota do ICMS.
09 COD_OBS Código da observação do lançamento C 006 - OC OC
...
e o dígito do quarto caractere for igual a “3”; “4” ou “5”. Neste caso o valor informado no campo 07 -
VL_ICMS gera um ajuste a crédito (campo 07- VL_AJ_CREDITOS) no registro E110 e também um
...
e o dígito do quarto caractere for igual a “3”; “4” ou “5”. Neste caso o valor informado no campo 07 -
VL_ICMS gera um ajuste a débito (campo 03- VL_AJ_DEBITOS) no registro E110 e também um
...
05 NUM_DOC_INI Número do primeiro documento fiscal N 006 - O
emitido (mesmo modelo, série e
subsérie)
06 NUM_DOC_FIN Número do último documento fiscal N - - O
emitido (mesmo modelo, série e
subsérie)
...
18 VL_RED_BC Valor não tributado em função da N - 02 O
redução da base de cálculo do ICMS,
referente à combinação de CST_ICMS,
CFOP e alíquota do ICMS.
19 COD_OBS Código da observação do lançamento C 006 - OC
fiscal (campo 02 do Registro 0460)
...
4.4.6
03 VLR_ACUM_TO Valor acumulado no totalizador, relativo à N - 02 O
T respectiva Redução Z.
Página 160 de 301

--- Página 161 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
04 NR_TOT Número do totalizador quando ocorrer N 002 - OC
mais de uma situação com a mesma carga
tributária efetiva.
05 DESCR_NR_TOT Descrição da situação tributária relativa C - - OC
ao totalizador parcial, quando houver
mais de um com a mesma carga tributária
efetiva.
Observações:
Nível hierárquico - 4
Ocorrência - vários (por arquivo)
...
02 COD_MUN_ORI Código do município de origem do N 007* - apresentar O
G serviço, conforme a tabela IBGE
03 VL_SERV Valor total da prestação de serviço N - 02 O
...
09 VL_BC_ICMS Base de cálculo do ICMS acumulada N - 02 O
relativa à alíquota informada
10 VL_ICMS Valor do ICMS acumulado relativo à N - 02 O
alíquota informada
...
02 COD_PART Código do participante (campo 02 do C 060 - apresentar O
Registro 0150):
- agência, filial ou posto
03 COD_MOD Código do modelo do documento C 002* - O
fiscal, conforme a Tabela 4.1.1
04 COD_SIT Código da situação do documento N 002* - O
...
11 VL_SERV Valor acumulado da prestação de N - 02 O
serviço
12 VL_BC_ICMS Valor total da base de cálculo do N - 02 OC
ICMS
...
06 NUM_DOC_FIN Número do documento fiscal N - - O
final(mesmo modelo, série e subsérie)
...
14 VL_BC_ICMS Valor acumulado da base de cálculo do N - 02 O
ICMS
...
11 DT_A_P Data da entrada (aquisição) ou da saída N 008* - OC OC
...
15 VL_SERV_NT Valor total dos serviços não-tributados pelo N - 02 OC O
ICMS
16 VL_TERC Valores cobrados em nome de terceiros N - 02 OC O
17 VL_DA Valor de outras despesas indicadas no N - 02 OC O
documento fiscal
...
06 UNID Unidade do item (Campo 02 do registro C 006 - O
0190)
...
14 VL_BC_ICMS_U Valor da base de cálculo do ICMS de outras N - 02 OC
F UFs
...
3- Receita própria - venda de serviço pré-
pago;
4- Outras receitas próprias;
5- Receitas de terceiros (co-faturamento);
9- Outras receitas de terceiros
17 COD_PART Código do participante (campo 02 do C 060 - OC
Registro 0150) receptor da receita, terceiro da
operação, se houver.
Página 168 de 301
...
4 - Multimídia;
9 - Outros
03 DT_INI_SERV Data em que se iniciou a prestação do N 008* - OC
serviço
04 DT_FIN_SERV Data em que se encerrou a prestação do N 008* - OC
serviço
...
02 CST_ICMS Código da Situação Tributária, conforme a N 003* - O O
tabela indicada no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação, N 004* - O O
conforme a tabela indicada no item 4.2.2
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC OC
...
e alíquota do ICMS
08 VL_BC_ICMS_UF Parcela correspondente ao valor da base de N - 02 O O
...
combinação de CST_ICMS, CFOP e alíquota
do ICMS.
11 COD_OBS Código da observação (campo 02 do C 006 - OC OC
Registro 0460)
Observações:
Nível hierárquico - 3
Ocorrência – 1:N
...
06 VL_BC_ICM Parcela correspondente ao “Valor da base de cálculo N - 02 O
S do ICMS” referente à combinação CST_ICMS,
CFOP, e alíquota do ICMS
07 VL_ICMS Parcela correspondente ao "Valor do ICMS" N - 02 O
referente à combinação CST_ICMS, CFOP, e
alíquota do ICMS
VL_BC_ICM Parcela correspondente ao valor da base de cálculo N - 02 O
08 S_UF do ICMS de outras UFs, referente à combinação de
CST_ICMS, CFOP e alíquota do ICMS.
VL_ICMS_U Parcela correspondente ao valor do ICMS de outras N - 02 O
09 F UFs, referente à combinação de CST ICMS, CFOP,
e alíquota do ICMS.
...
Código da Situação Tributária, conforme a N 003* - Apresentar O
02 CST_ICMS
tabela indicada no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação, N 004* - O
conforme a tabela indicada no item 4.2.2
...
alíquota do ICMS
Parcela correspondente ao valor da base de O
VL_BC_ICMS cálculo do ICMS de outras UFs, referente à
08 N - 02
_UF combinação de CST_ICMS, CFOP e alíquota
do ICMS
Parcela correspondente ao valor do ICMS de O
09 VL_ICMS_UF outras UFs, referente à combinação de N - 02
CST_ICMS, CFOP, e alíquota do ICMS
