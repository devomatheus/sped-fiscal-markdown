...
Nº Campo Descrição Tipo Ta Dec Obrig
m
...
14 VL_SLD_CREDOR_TRANSP Valor total de "Saldo credor a transportar para o N - 02 O
ORTAR período seguinte”
...
registros C197, C597 e D197, se o terceiro caractere do campo COD_AJ dos registros C197, C597 ou D197 for igual a ‘3’,
‘4’ ou ‘5’ e o quarto caractere for igual a “0”, “3”, “4”, “5”, “6”, “7” ou “8”. Deste somatório, estão excluídos os
documentos extemporâneos (COD_SIT com valor igual ‘01’) e os documentos complementares extemporâneos (COD_SIT
com valor igual ‘07’), cujos valores devem ser prestados no campo DEB_ESP acompanhado dos demais valores extra-
apuração.
Serão considerados os registros cujos documentos estejam compreendidos no período informado no registro E100, utilizando
para tanto o campo DT_E_S (C100 ou C500) e DT_DOC ou DT_A_P (D100). Quando o campo DT_E_S (C100 ou C500)
for vazio, utilizar o campo DT_DOC.
...
registros C190, C590, D190 e D590. Deste somatório, estão excluídos os documentos fiscais com CFOP 1605 -
...
registros C197, C597 e D197, se o terceiro caractere do código de ajuste dos registros C197, C597 ou D197 for ‘0’, ‘1’ ou
‘2’ e o quarto caractere for ‘0’, “3”, “4”, “5”, “6”, “7” ou “8”. Devem ser considerados os documentos fiscais
compreendidos no período informado no registro E100, analisando-se as datas informadas no campo DT_E_S do registro
C100 ou C500 e DT_DOC ou DT_A_P do registro D100, exceto se COD_SIT do registro C100 ou C500 e D100 for igual a
‘01’ (extemporâneo) ou igual a ‘07’ (Complementar extemporânea), cujo valor deve ser somado no primeiro período de
apuração informado no registro E100.
...
registros C197, C597 e D197, se o terceiro caractere do código de ajuste do registro C197, C597 ou D197, for ‘6’ e o quarto
Página 181 de 301
...
Para o somatório do campo VL_ICMS dos registros C197, C597 e D197 devem ser considerados os documentos fiscais
...
(extemporâneo) ou igual a ‘07’ (Complementar extemporânea), cujo valor deve ser somado no primeiro período de apuração
informado no registro E100, quando houver mais de um período de apuração. Quando o campo DT_E_S não for informado,
...
páginas.
b) de ajustes do campo VL_ICMS dos registros C197, C597 e D197, se o terceiro caractere do código informado no
campo COD_AJ do registro C197, C597 e D197 for igual a “7” (débitos especiais) e o quarto caractere for igual a
“0” (operações próprias) referente aos documentos compreendidos no período a que se refere a escrituração. No
PVA, estes valores podem ser verificados nos resumos dos Relatórios dos Registros Fiscais de Documentos de
...
02 COD_AJ_APU Código do ajuste da apuração e dedução, conforme a C 008* - O
R Tabela indicada no item 5.1.1.
03 DESCR_COMP Descrição complementar do ajuste da apuração. C - - OC
L_AJ
...
houver
03 NUM_PROC Número do processo ao qual o ajuste está vinculado, C 015 - OC
se houver
...
02 COD_INF_ADIC Código da informação adicional conforme C 008* - O
tabela a ser definida pelas SEFAZ, conforme
...
03 VL_SLD_CRED_ANT Valor do "Saldo credor de período anterior – N - 02 O
_ST Substituição Tributária"
...
07 VL_AJ_CREDITOS_S Valor total dos ajustes a crédito de ICMS ST, N - 02 O
T provenientes de ajustes do documento fiscal.
...
11 VL_SLD_DEV_ANT_ Valor total de Saldo devedor antes das deduções N - 02 O
ST
12 VL_DEDUÇÕES_ST Valor total dos ajustes "Deduções ST" N - 02 O
13 VL_ICMS_RECOL_S Imposto a recolher ST (11-12) N - 02 O
T
14 VL_SLD_CRED_ST_ Saldo credor de ST a transportar para o período N - 02 O
TRANSPORTAR seguinte [(03+04+05+06+07+12)– (08+09+10)].
...
dos registros C197, C597 e D197, por UF, se o terceiro caractere do código de ajuste no campo COD_AJ dos registros C197,
C597 e D197 for “0”, “1” ou “2” e o quarto caractere for “1”(um) para todos os registros onde os documentos estejam
compreendidos no período informado no registro E200, considerando a UF, utilizando para tanto o campo DT_E_S (C100 ou
C500) e DT_DOC ou DT_A_P (D100). Quando o campo DT_E_S (C100 ou C500) não estiver preenchido, a data
...
dos registros C197 e D197, por UF, se o terceiro caractere do código de ajuste (campo COD_AJ) dos registros C197, C597 e
D197 for ‘3’, ‘4’ ou ‘5’ e o quarto caractere for ‘1’, para todos os registros onde os documentos estejam compreendidos no
período informado no registro E200, por UF, utilizando-se, para tanto, o campo DT_E_S (C100 ou C500) e DT_DOC ou
DT_A_P (D100).
Quando a data do campo DT_E_S (C100 ou C500) não estiver preenchida, é utilizada a data do campo DT_DOC.
...
COD_AJ_APUR for igual a ‘4’, mais a soma do campo VL_ICMS dos registros C197, C597 e D197, se o terceiro caractere
do campo COD_AJ for ‘6’ e o quarto caractere for ‘1’, para todos os registros onde os documentos estejam compreendidos
no período informado no registro E200, por UF, utilizando-se, para tanto, o campo DT_E_S, do registro C100 ou C500 e
DT_DOC ou DT_A_P do registro D100.Quando o campo DT_E_S do registro C100 ou C500 não estiver preenchido, utilizar
o campo DT_DOC do mesmo registro.
...
b) de ajustes do campo VL_ICMS dos registros C197, C597 e D197, se o terceiro caractere do código informado no
campo COD_AJ dos registros C197, C597 e D197 for igual a “7” (débitos especiais) e o quarto caractere for igual a
“1” (operações por ST) referente aos documentos compreendidos no período a que se refere a escrituração; e
...
03 DESCR_COMPL_ Descrição complementar do ajuste da apuração C - - OC
AJ
04 VL_AJ_APUR Valor do ajuste da apuração N - 02 O
Observações:
Nível hierárquico - 4
...
02 COD_PART Código do participante (campo 02 do Registro C 060 - O
0150):
- do emitente do documento ou do remetente das
mercadorias, no caso de entradas;
- do adquirente, no caso de saídas
...
02 COD_OR Código da obrigação a recolher, conforme a Tabela C 003* - O
5.4
...
02 UF Sigla da unidade da federação a que se refere à C 002 - O
apuração do FCP e do ICMS Diferencial de
...
Alíquota da UF de Origem/Destino
03 VL_SLD_CRED_ANT_DIFAL Valor do "Saldo credor de período anterior – N - 02 O
...
Diferencial de Alíquota da UF de
Origem/Destino”
10 VL_SLD_DEV_ANT_DIFAL Valor total de Saldo devedor ICMS Diferencial N - 02 O
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.2
Atualização: 21 de maio de 2019
13 VL_SLD_CRED_TRANSPOR Saldo credor a transportar para o período N - 02 O
TAR seguinte referente a FCP e Imposto do
Diferencial de Alíquota da UF de
Origem/Destino
...
04 VL_TOT_DEBITOS_DIFAL Valor total dos débitos por "Saídas e prestações N - 02 O
com débito do ICMS referente ao diferencial de
alíquota devido à UF de Origem/Destino"
05 VL_OUT_DEB_DIFAL Valor total dos ajustes "Outros débitos ICMS N - 02 O
Diferencial de Alíquota da UF de
Origem/Destino" e “Estorno de créditos ICMS
Diferencial de Alíquota da UF de
...
Atualização: 21 de maio de 2019
Origem/Destino”
08 VL_SLD_DEV_ANT_DIFAL Valor total de “Saldo devedor ICMS N - 02 O
Diferencial de Alíquota da UF de
...
11 VL_SLD_CRED_TRANSPORTA Saldo credor a transportar para o período N - 02 O
R_DIFAL seguinte referente ao ICMS Diferencial de
Alíquota da UF de Origem/Destino
12 DEB_ESP_DIFAL Valores recolhidos ou a recolher, extra- N - 02 O
apuração - ICMS Diferencial de Alíquota da
UF de Origem/Destino.
13 VL_SLD_CRED_ANT_FCP Valor do "Saldo credor de período anterior – N - 02 O
FCP"
...
20 VL_RECOL_FCP Valor recolhido ou a recolher referente ao FCP N - 02 O
(18–19)
21 VL_SLD_CRED_TRANSPORTA Saldo credor a transportar para o período N - 02 O
R_FCP seguinte referente ao FCP
...
02 COD_AJ_APUR Código do ajuste da apuração e dedução, conforme C 008* - O
...
02 COD_OR Código da obrigação recolhida ou a recolher, conforme C 003* - O
a Tabela 5.4
...
02 CFOP Código Fiscal de Operação e Prestação do N 004* - O
agrupamento de itens
03 CST_IPI Código da Situação Tributária referente ao IPI, C 002* - O
conforme a Tabela indicada no item 4.3.2.
04 VL_CONT_IPI Parcela correspondente ao "Valor Contábil" N - 02 O
referente ao CFOP e ao Código de Tributação do
IPI
05 VL_BC_IPI Parcela correspondente ao "Valor da base de N - 02 O
cálculo do IPI" referente ao CFOP e ao Código de
Tributação do IPI, para operações tributadas
06 VL_IPI Parcela correspondente ao "Valor do IPI" N - 02 O
referente ao CFOP e ao Código de Tributação do
...
imposto"
04 VL_CRED_IPI Valor total dos créditos por "Entradas e aquisições N - 02 O
com crédito do imposto"
05 VL_OD_IPI Valor de "Outros débitos" do IPI (inclusive N - 02 O
estornos de crédito)
06 VL_OC_IPI Valor de "Outros créditos" do IPI (inclusive N - 02 O
estornos de débitos)
07 VL_SC_IPI Valor do saldo credor do IPI a transportar para o N - 02 O
período seguinte
...
05 IND_DOC Indicador da origem do documento vinculado ao C 001* - O
ajuste:
0 - Processo Judicial;
...
3 – Documento Fiscal
9 – Outros.
06 NUM_DOC Número do documento / processo / declaração ao C - - OC
...
regiões incentivadas - Lei nº estabelecimento industrial, dos produtos classificados nas
...
02 COD_PART Código do participante (campo 02 do Registro C 060 - OC
0150):
- do emitente do documento ou do remetente das
mercadorias, no caso de entradas;
- do adquirente, no caso de saídas
