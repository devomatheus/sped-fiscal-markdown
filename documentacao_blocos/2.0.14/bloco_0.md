...
Venda ao Consumidor, C460 – Documento Fiscal emitido por ECF.
Página 20 de 209
...
02 do Registro 0200)
03 QTD_COMP Quantidade do item componente/insumo para N 17 6 O
...
documentos fiscais ou nos registros do controle da produção e do estoque, Bloco K. Nos documentos eletrônicos de
emissão própria, quando a unidade comercial for diferente da unidade do inventário, este registro deverá ser informado.
Quando for utilizada unidade de inventário (bloco H) ou unidade de medida de controle de estoque (bloco K) diferente da
unidade comercial do produto é necessário informar o registro 0220 para informar os fatores de conversão entre as
unidades.
