...
ALÍQUOTA)
Deve existir um Registro 1975 para cada ALIQ_IMP_BASE, ainda que os campos G3_10, G3_11 e G3_12 sejam iguais a “0”
(zero).
Validação do Registro: Não podem ser informados, para um mesmo documento fiscal, dois ou mais registros com o mesmo
...
Campo 04 (G4_02) – Preenchimento: informar o valor total das entradas de produtos incentivados (PI) fora da faixa
de incentivo, conforme estabelecido pelo respectivo decreto concessivo.
