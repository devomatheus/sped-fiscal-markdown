...
campo CPF for informado, então o campo IND_ATIV deve ser igual a 1. Se campo IND_ATIV for igual a 1, não deve existir
o registro E500.
...
11 COD_MUN_SER Código do município onde o serviço C 007* - O O
V foi prestado, conforme a tabela IBGE.
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.3
Atualização: 14 de outubro de 2019
02 COD_MOD Código do modelo do documento C 002* - informar O
fiscal, conforme a Tabela 4.1.3
...
da alíquota e item da lista
04 ALIQ_ISS Alíquota do ISS N - 02 O
05 VL_ISNT_ISS Totalização do valor das N - 02 O
operações isentas ou não-
tributadas pelo ISS referente à
combinação da alíquota e item da
lista
...
do ISS
07 COD_SERV Item da lista de serviços, C - - O
conforme Tabela 4.6.3.
Observações:
Nível hierárquico - 2
Ocorrência – vários (por arquivo)
