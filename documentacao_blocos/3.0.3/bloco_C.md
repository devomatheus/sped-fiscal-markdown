...
03 VL_ICMS_UF_DES Valor total do ICMS Interestadual para a UF N - 02 O O
T de destino
...
02 CL_ENQ Código da classe de enquadramento do IPI, conforme C 005 - apresentar O
Tabela 4.5.1.
03 VL_UNID Valor por unidade padrão de tributação N - 02 O
04 QUANT_PA Quantidade total de produtos na unidade padrão de N - 03 O
D tributação
Observações:
Nível hierárquico - 4
Ocorrência - 1:1
...
campo “IND_OPER” do registro pai C100 deve ser igual a “0” - Entrada.
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C180” C 004 - O Não
apresentar
...
06 VL_UNIT_ICMS_OP_CONV Valor unitário do ICMS operação N - 06 O
...
por substituição, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”, aplicando-se
redução, se houver.
08 VL_UNIT_ICMS_ST_CONV Valor unitário do imposto pago ou N - 06 O
retido anteriormente por substituição,
inclusive FCP se devido, considerando a
unidade utilizada para informar o
campo “QUANT_CONV”.
09 VL_UNIT_FCP_ST_CONV Valor unitário do FCP_ST agregado ao N - 06 OC
...
Campo 5 (VL_UNIT_CONV), com redução de base de cálculo,
conforme a legislação da UF
* alíq. interna
...
Campo 07 (VL_UNIT_BC_ICMS_ST _CONV), com redução,
conforme a legislação da UF
...
“IND_OPER” do registro pai C100 deve ser igual a “1” - Saída
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C185” C 004 - Não O
apresentar
02 NUM_ITEM Número sequencial do item no N 003 - O
documento fiscal
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.3
Atualização: 14 de outubro de 2019
04 CST_ICMS Código da Situação Tributária referente N 003* - O
ao ICMS
05 CFOP Código Fiscal de Operação e Prestação N 004* - O
06 COD_MOT_REST_COMPL Código do motivo da restituição ou C 005* - O
complementação conforme Tabela 5.7
07 QUANT_CONV Quantidade do item N - 06 O
08 UNID Unidade adotada para informar o campo O
QUANT_CONV.
09 VL_UNIT_CONV Valor unitário da mercadoria, N - 06 O
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
10 VL_UNIT_ICMS_NA_OPE Valor unitário para o ICMS na operação, N - 06 OC
...
11 VL_UNIT_ICMS_OP_CON Valor unitário do ICMS que o N - 06 OC
V contribuinte teria se creditado, ou pode
se creditar, referente à operação de
entrada da mercadoria, caso estivesse
submetida ao regime comum de
tributação, no desfazimento da
substituição tributária, calculado
conforme a legislação de cada UF,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”
12 VL_UNIT_ICMS_OP_EST Valor médio unitário do ICMS que o N - 06 OC
...
considerando a unidade utilizada para
informar o campo “QUANT_CONV”
13 VL_UNIT_ICMS_ST_EST Valor médio unitário do ICMS ST, N - 06 OC
OQUE_CONV incluindo FCP ST, das mercadorias em
estoque, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”
14 VL_UNIT_FCP_ICMS_ST_ Valor médio unitário do FCP ST N - 06 OC
ESTOQUE_CONV agregado ao ICMS das mercadorias em
estoque, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”
15 VL_UNIT_ICMS_ST_CON Valor unitário do total do ICMS ST, N - 06 OC
V_REST incluindo FCP ST, a ser
restituído/ressarcido, calculado
conforme a legislação de cada UF,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
16 VL_UNIT_FCP_ST_CONV Valor unitário correspondente à parcela N - 06 OC
_REST de ICMS FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”,
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
17 VL_UNIT_ICMS_ST_CON Valor unitário do complemento do N - 06 OC
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.3
Atualização: 14 de outubro de 2019
18 VL_UNIT_FCP_ST_CONV Valor unitário correspondente à parcela N - 06 OC
_COMPL de ICMS FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMP
...
preenchidos
c) igual a 2, os campos 12, 13, 14, 15 e 16 devem ser preenchidos e os campos 10, 17 e 18 não devem ser
preenchidos. O campo 11 pode ser preenchido de acordo com a legislação de cada UF.
...
Campo 12 (VL_UNIT_ICMS_OP_ESTOQUE_CONV) : Preenchimento: Informar o valor médio unitário de ICMS OP,
das mercadorias em estoque. Obtido através do cálculo a partir do estoque incial de ICMS declarado no H030 (Campo 02 –
VL_ICMS_OP) adicionado às informações de ICMS declarado nos registros C180 (Campo 06 -
VL_UNIT_ICMS_OP_CONV) ocorridas até a data da sáida do documento declarado no C185.
...
Obtido através do cálculo a partir do estoque inicial de ICMS declarado no H030 (Campo 04 – VL_ICMS_ST) adicionado às
informações de ICMS declarado nos registros C180 (Campo 08 - VL_UNIT_ICMS_ST_CONV) ocorridas até a data da sáida
...
Campo 15 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento: Salvo disposição em contrário de legislação de cada
UF, o valor a ser ressarcido / restituído é calculado conforme as orientações a seguir.
...
unitário de ICMS correspondente ao cálculo a seguir. Salvo disposição em contrário de legislação de cada UF, o valor a ser
ressarcido / restituído é calculado conforme as orientações a seguir
Página 88 de 304
...
07 VL_UNIT_ICMS_OP_CON Valor unitário correspondente ao ICMS OP N - 06 OC
V utilizado no cálculo do ressarcimento /
restituição, no desfazimento da substituição
tributária, calculado conforme a legislação
de cada UF, considerando a unidade
utilizada para informar o campo
“QUANT_CONV”.
...
10 VL_UNIT_FCP_ICMS_ST_ Valor médio unitário do ICMS ST, N - 06 OC
ESTOQUE_CONV incluindo FCP ST, das mercadorias em
estoque, considerando unidade utilizada
para informar o campo “QUANT_CONV”.
...
pela UF do informante do arquivo. Se o terceiro caractere do código preenchido no campo “IND_REST_COMPL” for:
...
preenchidos
c) igual a 2, os campos 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 06, 13 e 14 não devem ser
preenchidos. O campo 07 pode ser preenchido de acordo com a legislação de cada UF.
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.3
Atualização: 14 de outubro de 2019
Campo 08 (VL_UNIT_ICMS_OP_ESTOQUE_CONV) - Preenchimento: Informar o valor médio unitário de ICMS OP,
das mercadorias em estoque. Obtido através do cálculo a partir do estoque incial de ICMS declarado no H030 (Campo 02 –
VL_ICMS_OP) adicionado às informações de ICMS declarado nos registros C180 (Campo 06 -
VL_UNIT_ICMS_OP_CONV) ocorridas até a data da sáida do documento declarado no C185.
O período para o cálculo do valor médio deve atender à legislação de cada UF. Ex. diário, mensal etc.
...
Campo 11 (VL_UNIT_ICMS_ST_CONV_REST) – Preenchimento: Salvo disposição em contrário de legislação de cada
UF, o valor a ser ressarcido / restituído é calculado conforme as orientações a seguir.
a) Nos casos de direito ao crédito do imposto, por não ocorrência do fato gerador presumido:
a.1) Quando o campo 11 (VL_UNIT_ICMS_OP_CONV) for obrigatório, de acordo com a legislação da UF,
correspondente ao seguinte cálculo, considerando a unidade utilizada para informar o campo “QUANT_CONV”:
...
redução da base de cálculo do ICMS ST na
tributação, se houver.
07 VL_UNIT_ICMS_OP_C Valor unitário correspondente ao ICMS OP N - 06 OC
ONV utilizado no cálculo do ressarcimento /
restituição, no desfazimento da substituição
tributária, calculado conforme a legislação de
cada UF, considerando a unidade utilizada
para informar o campo “QUANT_CONV”.
...
Campo 02 (COD_MOT_REST_COMPL) - Validação: o valor informado deve estar de acordo com a tabela 5.7 publicada
pela UF do informante do arquivo. Se o terceiro caractere do código preenchido no campo “COD_MOT_REST_COMPL”
for:
a) igual a 0, os campos 06 a 14 não devem ser preenchidos.
b) igual a 1, os campos 06, 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 07, 13 e 14 não devem ser
preenchidos.
...
houver.
07 VL_UNIT_ICMS_OP_CO Valor unitário do ICMS que o contribuinte N - 06 OC
NV teria se creditado, ou pode se creditar,
referente à operação de entrada da
mercadoria, caso estivesse submetida ao
regime comum de tributação, no
...
redução da base de cálculo do ICMS ST na
tributação, se houver.
07 VL_UNIT_ICMS_OP Valor unitário correspondente ao ICMS OP N - 06 OC
_CONV utilizado no cálculo do ressarcimento /
restituição, no desfazimento da substituição
tributária, calculado conforme a legislação de
cada UF, considerando a unidade utilizada
para informar o campo “QUANT_CONV”.
...
do registro 0000 estão dispensados do preenchimento deste campo. Apresentar conteúdo VAZIO “||”.
Campo 26 (TP_LIGACAO) - Valores válidos: [1, 2, 3]Validação: a informação é obrigatória nas operações de saídas, se
COD_MOD igual a “06”. Se COD_MOD for “66”, o campo não deve ser preenchido.
...
redução da base de cálculo do ICMS ST
na tributação, se houver.
07 VL_UNIT_ICMS_OP_CON Valor unitário correspondente ao ICMS N - 06 OC
V OP utilizado no cálculo do
ressarcimento / restituição, no
desfazimento da substituição tributária,
calculado conforme a legislação de cada
UF, considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
...
O
indicada no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação do agrupamento N 004 -
O
de itens
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
...
06 VL_BC_ICM Valor acumulado da base de cálculo do ICMS, referente N - 2
S à combinação de CST_ICMS, CFOP, e alíquota do O
ICMS.
...
redução da base de cálculo do ICMS ST na
tributação, se houver.
07 VL_UNIT_ICMS_OP_CON Valor unitário correspondente ao ICMS OP N - 03 OC
V utilizado no cálculo do ressarcimento /
restituição, no desfazimento da substituição
tributária, calculado conforme a legislação
de cada UF, considerando a unidade
