...
02 IND_CARGA Indicador do tipo de transporte da carga N 001* - apresentar O
coletada:
0-Rodoviário
1-Ferroviário
2-Rodo-Ferroviário
...
e) O campo VL_RED_BC só pode ser preenchido se os dois últimos dígitos do campo CST_ICMS forem iguais a
20, 70 ou 90. O primeiro caractere do código do CST deverá ser igual a 0 (zero)
