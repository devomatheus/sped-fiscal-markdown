# Bloco C - Versão 3.0.9

**Data de Criação:** 2022-02-23  
**Páginas:** 60-164  
**Versão:** 3.0.9
...
Atualização: 23 de fevereiro de 2022
Nível hierárquico - 1
...
de terceiros em operações de saídas (exemplo: consórcios de empresas), deve ser informado no campo 06 (COD_SIT) o
código “08”.
...
alíquota do ICMS
08 VL_BC_ICMS_ST Valor da base de cálculo do ICMS N - 02 O
Página 150 de 340
...
indicada no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação do N 004 - O
agrupamento de itens
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
...
referente à combinação de CST_ICMS, CFOP e
ALÍQUOTA DO ICMS.
07 VL_ICMS Parcela correspondente ao "Valor do ICMS" referente N - 02 O
