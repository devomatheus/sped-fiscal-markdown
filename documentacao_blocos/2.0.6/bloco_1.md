...
10 VAL_AJ_GANH Valor do ganho, em litros N - 03 O
O
...
09 VAL_AJ_GANH Valor do ganho, em litros N - 03 O
O
...
identificação da administradora do cartão de
débito/crédito
03 TOT_CREDITO Valor total das operações realizadas no período referente N - 002 O
a Cartão de Crédito
04 TOT_DEBITO Valor total das operações realizadas no período referente N - 002 O
a Cartão de Débito
Página 145 de 145165
...
06 NUM_DOC_IN N 012 -
I Número do dispositivo autorizado (utilizado) inicial
07 NUM_DOC_FI N 012 -
N Número do dispositivo autorizado (utilizado) final
...
4 – APURAÇÃO 2;
5 – APURAÇÃO 3.
03 DESCR_COMPL_OUT_APUR Descrição complementar de Outra C - - O
Apuração do ICMS
Observações:
Nível hierárquico - 2
Ocorrência - 1:N
...
12 VL_SLD_CREDOR_TRANSP_OA Valor total de "Saldo credor a N - 02 O
...
05 COD_REC Código de receita referente à obrigação, próprio da unidade C - - O
da federação, conforme legislação estadual,
