...
Exceção 5: Escrituração de documentos emitidos por terceiros em operações de saídas:
Nestes casos, devem ser informados com código de situação do documento igual a “08” - Documento Fiscal emitido com
base em Regime Especial ou Norma Específica. Consideram-se ainda como documentos emitidos por terceiros os emitidos
por estabelecimentos filiais de empresas que possuem inscrição estadual única ou centralizada. O PVA-EFD exibirá a
mensagem de Advertência para esses documentos.
