...
“VL_ICMS_ST” e/ou “VL_IPI” dos registro C100, C170 e C190 não devem ser informados.”
...
COTEPE/ICMS nº 09, de 18 de abril de 2008, reproduzida na subseção 6.4 deste guia.O código a ser informado não é
...
Validação: quando se tratar de NF-e, é conferido o dígito verificador (DV) da chave da NF-e. Será verificada a
consistência da informação dos campos NUM_DOC e SER com o número do documento e série contidos na chave da NF-
e. Quando se tratar de CT-e, é conferido o dígito verificador (DV) da chave do CT-e. Será verificada a consistência da
informação dos campos NUM_DOC e SER e o número do documento contidos na chave do CT-e.
...
Campo 02 (COD_MOD) - Valores válidos: [02, 2D, 2E] – Ver tabela reproduzida na subseção 6.4 deste guia.
...
– Ver tabela reproduzida na subseção 6.4 deste guia.
...
Guia Prático EFD-ICMS/IPI – Versão 2.0.19
Atualização: 05/05/2016
Campo 02 (COD_MOD) - Valor Válido: [02] - – Ver tabela reproduzida na subseção 6.4 deste guia.
...
Guia Prático EFD-ICMS/IPI – Versão 2.0.19
Atualização: 05/05/2016
Campo 02 (COD_MOD) - Valores válidos: [02, 2D, 60] - – Ver tabela reproduzida na subseção 6.4 deste guia..
...
Campo 03 (IND_EMIT) - Valores válidos: [0, 1]
Campo 04 (COD_PART) - Validação: o valor informado deve existir no campo COD_PART do registro 0150.
Campo 05 (COD_MOD) - Valores válidos: [06, 28, 29] - – Ver tabela reproduzida na subseção 6.4 deste guia.
...
Campo 02 (COD_MOD) - Valores válidos: [06, 28, 29] - – Ver tabela reproduzida na subseção 6.4 deste guia.
...
Campo 02 (COD_MOD) - Valor Válido: [06, 28] - – Ver tabela reproduzida na subseção 6.4 deste guia.
...
conforme item 4.5 do Anexo Único (Manual de Orientação) do Convênio ICMS 115/2003.
