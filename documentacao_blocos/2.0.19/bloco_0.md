...
c) Informar no campo COD_MUN o código de município correspondente à capital do estado do tomador de
serviços.
...
qual é conhecida.
REGISTRO 0015: DADOS DO CONTRIBUINTE SUBSTITUTO OU RESPONSÁVEL
PELO ICMS DESTINO
...
neste registro.
Obs.: Não devem ser informados como participantes os CNPJ e CPF apenas citados nos registros
C350 – Nota Fiscal de Venda ao Consumidor, C460 – Documento Fiscal emitido por ECF e no C100,
...
informante em sua Contabilidade Geral, relativas às contas referenciadas no registro 0300. Não podem
ser informados dois ou mais registros com a mesma combinação de conteúdo nos campos DT_ALT e
COD_CTA.
Nº Campo Descrição Tipo Tam Dec Obrig
