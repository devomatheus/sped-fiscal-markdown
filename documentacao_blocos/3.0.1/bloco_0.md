...
produto, se houver
05 COD_ANT_ITEM Código anterior do item com relação à última informação C 060 - N (informar no
apresentada. 0205)
...
Nº Campo Descrição Ti Tam Dec Ent Saí
p r da
o
...
0 - Emissão própria;
1 - Terceiros
04 COD_PART Código do participante (campo 02 do Registro C 060 - O OC
0150):
...
a Tabela 4.1.3
06 COD_SIT Código da situação do documento conforme tabela N 002* - O O
4.1.2
...
11 COD_MUN_ Código do município onde o serviço foi prestado, C 007* - O O
SERV conforme a tabela IBGE.
12 VL_CONT Valor contábil (valor total do documento) N - 02 O O
13 VL_MAT_T Valor do material fornecido por terceiros na N - 02 O O
ERC prestação do serviço
14 VL_SUB Valor da subempreitada N - 02 O O
15 VL_ISNT_IS Valor das operações isentas ou não-tributadas pelo N - 02 O O
S ISS
16 VL_DED_B Valor da dedução da base de cálculo N - 02 O O
C
17 VL_BC_ISS Valor da base de cálculo do ISS N - 02 O O
18 VL_BC_ISS Valor da base de cálculo de retenção do ISS N - 02 O O
_RT
19 VL_ISS_RT Valor do ISS retido pelo tomador N - 02 O O
20 VL_ ISS Valor do ISS destacado N - 02 O O
21 COD_INF_O Código da observação do lançamento fiscal C 060 - OC OC
BS (campo 02 do Registro 0460)
Observações:
Nível hierárquico - 2
Ocorrência – vários (por arquivo)
...
Nº Campo Descrição Tipo Tam De Entr. Saídas
c
...
03 VL_BC_ISS_P Parcela correspondente ao "Valor da N - 02 O O
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.1
Atualização: 28 de janeiro de 2019
05 NUM_DOC_FIN Número do último documento fiscal emitido N 009 - O
no dia
...
documentos)
09 VL_ISNT_ISS Valor acumulado das operações isentas ou N - 02 O
não-tributadas pelo ISS
10 VL_BC_ISS Valor acumulado da base de cálculo do ISS N - 02 O
...
Contábil" referente à combinação da
alíquota e item da lista
03 VL_BC_ISS_P Parcela correspondente ao "Valor da N - 02 O
base de cálculo do ISS" referente à
combinação da alíquota e item da
lista
04 ALIQ_ISS Alíquota do ISS N - 02 O
05 VL_ISS_P Parcela correspondente ao "Valor do N - 02 O
ISS" referente à combinação da
alíquota e item da lista
...
combinação da alíquota e item da
lista
07 COD_SERV Item da lista de serviços, conforme C 004* - O
Tabela 4.6.3.
Observações:
Nível hierárquico – 3
Ocorrência – 1:N
...
04 NUM_PROC Número do processo ao qual o ajuste C - - OC OC
está vinculado, se houver
05 IND_PROC Indicador da origem do processo: C 001* - OC OC
0- Sefin;
1- Justiça Federal;
2- Justiça Estadual;
9- Outros
