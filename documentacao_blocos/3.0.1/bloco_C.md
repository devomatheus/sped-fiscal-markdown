# Bloco C - Versão 3.0.1

**Data de Criação:** 2019-01-01  
**Páginas:** 55-116  
**Versão:** 3.0.1
...
5 – Aéreo;
9 – Outros.
03 CNPJ_COL Número do CNPJ do contribuinte do local de N 014* - OC
coleta
Página 65 de 272
...
04 IE_COL C 014 -
coleta
CPF_COL CPF do contribuinte do local de coleta das
05 N 011*
mercadorias
OC0 OC
COD_MUN_COL Código do Município do local de coleta N 007* -
6
...
34 QUANT_BC_COFINS Quantidade – Base de cálculo COFINS N - 03 OC
...
02 COD_INF_I Código da informação adicional de acordo com tabela C 008* - O O
TEM a ser publicada pelas SEFAZ, conforme tabela
...
O06 CNPJ_CPF CNPJ ou CPF do destinatário N 014 - OC
...
ALIQ_ICMS e VL_ICMS deverão ser maiores ou iguais a “0” (zero);
ICMS ST: a) se os dois últimos caracteres deste campo forem 10, 30 ou 70, os valores dos campos VL_BC_ST,
...
Atualização: 28 de janeiro de 2019
retenção ST
03 VL_BC_ICMS_ST Valor da base de cálculo do ICMS substituição N - 02 apresentar O
tributária
...
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
05 VL_OPR “Valor total do CF-e” na combinação de CST_ICMS, CFOP e N - 02 Não
alíquota do ICMS, correspondente ao somatório do valor apre O
líquido dos itens. sen
06 VL_BC_ICM Valor acumulado da base de cálculo do ICMS, referente à N - 2 tar
O
S combinação de CST_ICMS, CFOP, e alíquota do ICMS.
