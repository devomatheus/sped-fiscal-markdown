...
02 COD_ITEM_DE Código do item de destino (campo 02 do Registro C 060 - O
S 0200)
...
Atualização: 28 de janeiro de 2019
0200)
04 COD_ITEM_DE Código do item de destino (campo 02 do Registro C 60 - O
ST 0200)
...
DT_FIN_AP
apontamento que está sendo corrigido
04 COD_OP_OS Código de identificação da ordem de produção ou da ordem C 030 - OC
de serviço que está sendo corrigida
05 COD_ITEM Código da mercadoria que está sendo corrigido (campo 02 do C 060 - O
Registro 0200)
06 N - 6 OC
...
07 N - 6 OC
QTD_COR_NE Quantidade de correção negativa de apontamento ocorrido em
G período de apuração anterior
