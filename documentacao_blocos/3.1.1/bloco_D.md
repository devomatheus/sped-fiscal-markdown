...
somente os campos REG, IND_OPER, IND_EMIT, COD_PART, COD_MOD, COD_SIT, SER, NUM_DOC e DT_DOC
são obrigatórios. Os demais campos são facultativos (se forem preenchidos, serão validados e aplicadas as regras de campos
...
02 COD_MOD C 002* -
Tabela 4.1.1
03 SER Série do documento fiscal C 003 - - O
...
08 VL_SERV Valor dos serviços tributados pelo ICMS. N - 02 O O
Valores cobrados em nome do prestador sem destaque de
09 VL_SERV_NT N - 002 O O
ICMS.
