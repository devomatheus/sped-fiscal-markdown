# Bloco C - Versão 3.1.1

**Data de Criação:** 2022-08-04  
**Páginas:** 61-169  
**Versão:** 3.1.1
...
preenchido na ocasião da saída
Valor médio unitário do FCP ST agregado
ao ICMS das mercadorias em estoque,
...
fiscal com serviço tributado pelo município (ISS), os totalizadores desse serviço também deverão ser informados nesse campo
cujo conteúdo será Snnnn ou xxSnnnn, onde "nnnn" representa a carga tributária efetiva do imposto com duas casas
...
02 CHV_CFE Chave do Cupom Fiscal Eletrônico N 044 - O
03 NUM_CCF Número do Contador de Cupom Fiscal N 009 - apresentar O
Observações:
Nível hierárquico - 5
Ocorrência - 1:1
...
estoque, considerando unidade utilizada
para informar o campo “QUANT_CONV”.
10 VL_UNIT_FCP_ICMS_ST_ Valor médio unitário do FCP ST N - 03 OC
ESTOQUE_CONV agregado ao ICMS das mercadorias em
estoque, considerando unidade utilizada
para informar o campo “QUANT_CONV”.
