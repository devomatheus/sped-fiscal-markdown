...
informante do arquivo. Serão verificados a consistência da informação do campo NUM_DOC e o número do documento
...
obrigadas a apurações em separado.
...
referem aos valores do ICMS das operações próprias estornados do registro E110através de ajustes nos campos 03
(VL_AJ_DEBITOS) e 07 (VL_AJ_CREDITOS).
Nº Campo Descrição Tipo Tam Dec Obrig
...
Página 141 de 168168

--- Página 142 ---
Guia Prático EFD – Versão 2.0.2
Atualização: 08 de setembro de 2010
11 VL_ICMS_RECOLHER_OA Valor total de "ICMS a recolher (11-12) N - 02 O
