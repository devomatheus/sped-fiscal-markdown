...
“IM”;
1.3) o componente será informado com tipo de movimentação “IA”, devendo ser informados os campos
NUM_PARC e VL_PARC_PASS. Nos períodos seguintes deve ser informado com o tipo de movimentação “SI” e
a apropriação das parcelas deverá ser controlada pelo código individual desse componente até a sua respectiva
baixa. Quando da conclusão da construção do bem, não deverá ser apresentado o registro com tipo de
...
apresentados 02 registros: um registro com tipo de movimentação “SI”, com os campos NUM_PARC e
VL_PARC_PASS preenchidos, representando a apropriação da parcela do período de referência; e um outro
registro com tipo de movimentação igual a “AT”, “PE” ou “OT”, conforme o caso, representando a saída do
CIAP. Nesse 2º registro os campos VL_IMOB_ICMS_OP, VL_IMOB_ICMS_ST, VL_IMOB_ICMS_FRT,
VL_IMOB_ICMS_DIF, NUM_PARC e VL_PARC_PASS não podem ser informados. (inciso V do § 5º do art. 20
da LC 87/96).
...
o valor do ICMS originado do documento fiscal;
