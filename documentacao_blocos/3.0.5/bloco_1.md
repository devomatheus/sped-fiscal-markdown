...
S – Sim;
N - Não
08 IND_CART Reg 1600 - Realizou vendas com Cartão de Crédito ou de C 001* - O
débito:
S – Sim;
N - Não
09 IND_FORM Reg. 1700 –- Foram emitidos documentos fiscais em C 001* - O
papel no período em unidade da federação que exija o
controle de utilização de documentos fiscais:
S – Sim
N - Não
...
registro é o campo 02 (COD_MOT_REST_COMP).
Nº Campo Descrição Tipo Tam Dec Obrig
...
do registro 1300.
REGISTRO 1320: VOLUME DE VENDASREGISTRO 1320: VOLUME DE VENDAS
...
OObs.: O registro somente poderá ser informado em períodos de apuração posteriores a julho de 2012.
Nº Campo Descrição Tipo Tam Dec Obrig
...
1 COD_ITEM Informar o insumo conforme código do item (campo 02 do C 060 - O
8 Registro 0200)
...
NCampo Descrição Tipo Tam D Obrig.
º ec
...
7 – APURAÇÃO 5;
8 – APURAÇÃO 6.
03 DESCR_COMPL_OUT_APU Descrição complementar de Outra Apuração do C - - O
R ICMS
...
NCampo Descrição Tipo Tam Dec Obrig
º
