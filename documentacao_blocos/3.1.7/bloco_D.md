...
ser informados os respectivos Registros D130.
...
Campo 14 (CHV_CTE_REF) - Preenchimento: Quando o campo 13 (TP_CT-e) for igual a “3 ou 5”, informar a chave do
...
Validação: Se CT-e simplificado (COD_MOD 57 e TP_CTe 4 ou 5), o valor deve ser igual à soma do campo VL_FRT do(s)
registro(s) D130 existentes.
...
Eletrônico Simplificado (Código 57, TP_CTe 4 e 5).
