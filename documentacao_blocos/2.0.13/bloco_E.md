...
haver mais de um registro com a mesma combinação de valores para os campos UF, DT_INI e DT_FIN, nem sobreposição
ou omissão de períodos para a combinação.
Nº Campo Descrição Tipo Tam Dec Obrig
