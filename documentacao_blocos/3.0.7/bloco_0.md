...
1 Informações adicionais dos ajustes da sub-apuração do ICMS - Identificação 1923 6 1N
...
2) Informar no campo IE a inscrição estadual na unidade federada do tomador de serviços/consumidor de energia
elétrica;
...
(CÓDIGO 08), NF-e (CÓDIGO 55), NFC-e (CÓDIGO 65) e NF3-e (CÓDIGO 66).
...
“55”, e para NF3-e, COD_MOD igual a “66”, de emissão própria ou de terceiros e para NFC-e, COD_MOD igual a
“65” de emissão própria. Se não existir Série para NF-e, NFC-e ou NF3-e informar 000.
