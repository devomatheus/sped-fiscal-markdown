# Bloco C - Versão 3.0.7

**Data de Criação:** 2021-08-26  
**Páginas:** 58-161  
**Versão:** 3.0.7
...
C181 ou o Registro C177 (no caso de haver informações complementares do item, a partir de 01/01/2019 - Tabela 5.6). A
critério de cada UF, informar os registros C110 e C120, a partir de julho de 2012. O registro C101 deverá ser informado, a
partir de janeiro/2016, nas operações interestaduais que destinem bens e serviços a consumidor final não contribuinte do
ICMS, conforme EC 87/15. A partir de janeiro de 2020, também poderá ser informado o Registro C185, a critério de cada
UF. A partir de janeiro de 2021, poderá ser informado o Registro C186, a critério de cada UF.
...
documento maior que a data de entrada ou saída. Exemplo: aquisição de cana-de-açúcar, venda de derivados de petróleo, etc.
...
NF-e e NFC-e, emitidos por terceiros (como por exemplo. o consórcio constituído nos termos do disposto nos artigos. 278 e
279 da Lei nº 6.404, de 15 de dezembro de 1976) e das NF-e “avulsas” emitidas pelas UF (séries 890 a 899) devem ser
informados como emissão de terceiros, com o código de situação do documento igual a “08 - Documento Fiscal emitido com
base em Regime Especial ou Norma Específica”. O PVA-EFD-ICMS/IPI exibirá a mensagem de Advertência para esses
documentos. Obs.: Os documentos fiscais emitidos pelas filiais das empresas que possuam inscrição estadual única ou sejam
...
campo COD_PART, campo COD_MOD, campo COD_SIT, campo SER, campo NUM_DOC e campo
CHV_NFE;
 para documentos com campo (IND_EMIT igual “0-Emissão Própria”: campo IND_OPER, campo
IND_EMIT, campo COD_MOD, campo COD_SIT, campo SER, campo NUM_DOC e campo CHV_NFE.
...
tributária
24 VL_ICMS_ST Valor do ICMS retido por substituição N - 02 OC OC
tributária
...
de terceiros em operações de saídas (exemplo: consórcios de empresas), deve ser informado no campo 06 (COD_SIT) o códi-
go “08”.
Se a legislação estadual a que estiver submetido o contribuinte obrigá-lo a escriturar notas fiscais avulsas em operação de saí-
da, este campo deve ser informado com valor igual a “0” (zero).
...
neste campo.
Campo 25 (VL_IPI) - Validação: a soma dos valores do campo VL_IPI dos registros analíticos (C190) deve ser igual ao va-
lor informado neste campo.
Página 63 de 331
...
Este registro tem por objetivo prestar informações complementares constantes da NF-e quando das operações interestaduais
destinadas a consumidor final NÃO contribuinte do ICMS, segundo dispôs a Emenda Constitucional 87/2015. Deverão ser informadas as
apurações do E300 e filhos para as UF de origem e destino da operação.
...
03 VL_ICMS_UF_DEST Valor total do ICMS Interestadual para a UF N - 02 O O
Página 64 de 331
...
arrecadação, ou data do vencimento, no caso de
...
“ddmmaaaa”.
Como a data de pagamento é uma informação obrigatória, deve ser preenchida mesmo que o documento de arrecadação ainda não tenha
sido pago, situação em que a data de vencimento deve ser informada neste campo. Por exemplo, nos casos de ICMS antecipado.
...
instituída pelo Ato COTEPE/ICMS nº 44/2018 e alterações, reproduzida na subseção 1.4 deste guia.
Validação: o valor informado no campo deve existir na Tabela de Documentos Fiscais do ICMS (tabela 4.1.1 da Nota
Técnica, instituída pelo Ato COTEPE/ICMS nº 44/2018 e alterações). O valor informado neste campo deve ser diferente de
“2D”, “02” e “2E”.
Campo 08 (NUM_DOC) - Validação: o valor informado no campo deve ser maior que “0” (zero).
...
5 – Aéreo;
9 – Outros.
Número do CNPJ do contribuinte do OC
03 CNPJ_COL N 014* -
local de coleta
Inscrição Estadual do contribuinte do OC
04 IE_COL C 014 -
local de coleta
CPF_COL CPF do contribuinte do local de coleta OC
05 N 011* -
das mercadorias
...
Este registro deve ser apresentado pelas empresas do segmento de combustíveis (distribuidoras, refinarias, revendedoras) em
operações de saída. Postos de combustíveis não devem apresentar este registro.
Validação do Registro: Não podem ser informados para um mesmo documento fiscal, dois ou mais registros com a mesma
combinação de conteúdo nos campos COD_PART e VEIC_ID.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
04 COD_AUT Código da autorização fornecido pela C - - OC
Página 74 de 331
...
02 NUM_ITEM Número sequencial do item no documento N 003 - O O
fiscal
...
16 VL_BC_ICMS_ST Valor da base de cálculo referente à N - 02 OC OC
substituição tributária
17 ALIQ_ST Alíquota do ICMS da substituição tributária na N - 02 OC OC
unidade da federação de destino
18 VL_ICMS_ST Valor do ICMS referente à substituição N - 02 OC OC
tributária
...
28 QUANT_BC_PIS Quantidade – Base de cálculo PIS N - 03 OC
...
COFINS.
32 VL_BC_COFINS Valor da base de cálculo da COFINS N - 02 OC
33 ALIQ_COFINS Alíquota do COFINS (em percentual) N 008 04 OC OC
34 QUANT_BC_COF Quantidade – Base de cálculo COFINS N - 03 OC
INS
...
Registro 0200, o valor informado deve existir no registro 0220 para o código do item (Campo 03 - COD_ITEM desse
registro) com a correspondente conversão.
...
98 Outras Operações de Entrada
99 Outras Operações
***Os contribuintes que entregarem a EFD-Contribuições relativa ao mesmo período de apuração do registro 0000 estão dispensados do
preenchimento deste campo. Ou seja, deverá ser apresentados com conteúdo VAZIO “||”.
...
importadoras), exceto comércio varejista. A obrigatoriedade deriva do §26 do art. 19 do Convênio S/N de 1970:
...
relativa às operações com produtos veterinários, homeopáticos ou amostras grátis, deverá conter,
na descrição prevista na alínea “b” do inciso IV deste artigo, a indicação do valor correspondente
ao preço constante da tabela, sugerido pelo órgão competente para venda a consumidor e, na falta
deste preço, o valor correspondente ao preço máximo de venda a consumidor sugerido ao público
...
04 DESCR_COMPL Descrição da arma, compreendendo: número C - - O
do cano, calibre, marca, capacidade de
cartuchos, tipo de funcionamento, quantidade
de canos, comprimento, tipo de alma,
quantidade e sentido das raias e demais
...
o documento referente à(s) última(s) aquisição(ões) da mercadoria e à retenção do imposto. Caso a legislação determine o
cálculo do ressarcimento com base na respectiva aquisição, não deverá ser informada a última aquisição no registro C176,
mas aquela indicada pela legislação.
...
comum de tributação
13 ALIQ_ICMS_ULT_E Alíquota do ICMS aplicável à última N - 02 O
...
completo) de ICMS decorrente da quebra
da ST
...
9 - Outros
20 CHAVE_NFE_RET Número completo da chave da NF-e N 044* - OC
emitida pelo substituto, na qual consta o
...
estadual, se houver
27 Valor unitário do ressarcimento (parcial ou N - 03 OC
VL_UNIT_RES_FCP completo) de FCP decorrente da quebra da
_ST ST
...
campo COD_PART_ULT_E deste registro for o substituído, informar o valor unitário que seria atribuído à base de cálculo
do ICMS na operação própria do remetente, caso esta fosse submetida ao regime comum de tributação.
Validação: o valor informado no campo deve ser maior que “0” (zero).
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.7
Atualização: 26 de agosto de 2021
Nacional, informar o valor unitário que seria atribuído à base de cálculo do ICMS se a operação estivesse submetida ao
...
Preenchimento: Se o emitente informado no campo COD_PART_ULT_E deste registro for o substituto, informar o valor
unitário destacado no documento fiscal a título de ICMS, ou caso o substituto seja contribuinte enquadrado no Simples
Nacional, informar o valor unitário que seria destacado se a operação estivesse submetida ao regime comum de tributação;
...
sujeitos ao selo de controle, pelos fabricantes ou importadores desses produtos. Exemplo: bebidas quentes, cigarros e
relógios. Se o produto vendido está sujeito à selagem, o registro é obrigatório.
...
Valor do ICMS ST a complementar à UF OC
...
A obrigatoriedade e a forma de escrituração deste registro serão definidas pela UF de domicílio do contribuinte. O
campo “IND_OPER” do registro pai C100 deve ser igual a “0” - Entrada. Este registro não poderá ser informado se houver
um registro C181 preenchido.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
descontos e acréscimos incondicionais aplicados sobre o valor bruto). O valor unitário do campo 05 não inclui o ICMS ST na
aquisição de participante substituto ou nas hipóteses em que o informante é responsável pela substituição.
...
(VL_UNIT_BC_ICMS_ST _CONV), aplicada a redução de base de cálculo se houver, multiplicada pela alíquota interna
...
Nº Campo Descrição Tipo Tam Dec Entr Saída
Não
01 REG Texto fixo contendo "C181” C 004 - O
apresentar
...
a) igual a 5, os campos 16 a 21 não devem ser preenchidos. Os campos 13, 14 e 15 podem ser preenchidos de
acordo com a legislação da UF. Se um desses campos for preenchido (13 a 15), todos os campos deste intervalo
devem ser preenchidos.
b) igual a 6, os campos 20 e 21 devem ser preenchidos e os campos 17, 18 e 19 não devem ser preenchidos. Os
campos 13, 14, 15 e 16 podem ser preenchidos de acordo com a legislação de cada UF. Se um desses campos
for preenchido (13 a 16), todos os campos deste intervalo devem ser preenchidos.
c) igual a 7, os campos 20 e 21 devem ser preenchidos e os campos 18 e 19 não devem ser preenchidos. O campo
13, 14, 15 e 17 podem ser preenchidos de acordo com a legislação de cada UF. Se o campo 17 for preenchido, ,
os campos 13, 14 e 15 também devem ser preenchidos.
d) igual a 8, os campos 18 e 19 devem ser preenchidos e os campos 17, 20 e 21 não devem ser preenchidos. Os
campos 13, 14, 15 e 16 podem ser preenchidos de acordo com a legislação de cada UF. Se um desses campos
for preenchido (13 a 16), todos os campos deste intervalo devem ser preenchidos.
Campo 03 (QUANT_CONV) – Preenchimento: Quantidade do item convertida na unidade de controle de estoque
informada no registro 0200 ou a unidade de comercialização, a critério de cada UF.
...
Campo 16 (VL_UNIT_ICMS_NA_OPERACAO_CONV_SAIDA) – Preenchimento: A obrigatoriedade de informação
deste campo deve seguir a legislação de cada UF.
...
expresso no campo 13 (VL_UNIT_ICMS_OP_ESTOQUE_CONV_SAIDA), seu preenchimento será facultativo. O valor
deste campo, quando obrigatório pela legislação da UF, será utilizado para o cálculo do valor do estorno do
ressarcimento/restituição do campo (VL_UNIT_ICMS_ST_CONV_COMPL), conforme fórmula a seguir:
...
Validação: Quando o preenchimento dos campos 13, 14, 15 e 16 for obrigatório de acordo com a legislação da UF, o valor
do estorno do complemento é calculado conforme as orientações a seguir:
Página 94 de 331
...
inferior ao valor da BC ICMS ST, quando o preenchimento dos campos 13, 14, 15 e 16 for obrigatório de
acordo com a legislação da UF, informar o valor unitário de ICMS correspondente ao seguinte cálculo,
...
A obrigatoriedade e a forma de escrituração deste registro serão definidas pela UF de domicílio do contribuinte. O
campo “IND_OPER” do registro pai C100 deve ser igual a “1” – Saída. Este registro não poderá ser informado se houver um
registro C186 preenchido.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
informar o campo “QUANT_CONV”.
10 VL_UNIT_ICMS_NA_OPE Valor unitário para o ICMS na operação,
RACAO_CONV caso não houvesse a ST, considerando
unidade utilizada para informar o campo
N - 06 OC
“QUANT_CONV”, considerando
redução da base de cálculo do ICMS ST
na tributação, se houver.
11 VL_UNIT_ICMS_OP_CON Valor unitário do ICMS OP calculado
...
15, no item a1).
12 VL_UNIT_ICMS_OP_EST Valor médio unitário do ICMS que o
...
considerando a unidade utilizada para
informar o campo “QUANT_CONV”
13 VL_UNIT_ICMS_ST_EST Valor médio unitário do ICMS ST,
OQUE_CONV incluindo FCP ST, das mercadorias em
estoque, considerando a unidade N - 06 OC
utilizada para informar o campo
“QUANT_CONV”
14 VL_UNIT_FCP_ICMS_ST_ Valor médio unitário do FCP ST
ESTOQUE_CONV agregado ao ICMS das mercadorias em
estoque, considerando a unidade N - 06 OC
utilizada para informar o campo
“QUANT_CONV”
15 VL_UNIT_ICMS_ST_CON Valor unitário do total do ICMS ST,
...
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
16 VL_UNIT_FCP_ST_CONV Valor unitário correspondente à parcela
_REST de ICMS FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_REST”, N - 06 OC
considerando a unidade utilizada para
informar o campo “QUANT_CONV”.
17 VL_UNIT_ICMS_ST_CON Valor unitário do complemento do
V_COMPL ICMS, incluindo FCP ST, considerando
N - 06 OC
a unidade utilizada para informar o
campo “QUANT_CONV”.
18 VL_UNIT_FCP_ST_CONV Valor unitário correspondente à parcela
_COMPL de ICMS FCP ST que compõe o campo
“VL_UNIT_ICMS_ST_CONV_COMP N - 06 OC
L”, considerando unidade utilizada para
informar o campo “QUANT_CONV”.
Página 96 de 331
...
pela UF do informante do arquivo com o terceiro caractere igual a 0, 1, 2 ou 3.Se o terceiro caractere do código preenchido
no campo “COD_MOT_REST_COMPL” for:
...
c) igual a 2, os campos 12, 13, 14, 15 e 16 devem ser preenchidos e os campos 10, 17 e 18 não devem ser preenchidos. O
campo 11 pode ser preenchido de acordo com a legislação de cada UF.
...
informada no registro 0200 ou na unidade de comercialização, a critério de cada UF.
Validação: o valor informado no campo deve ser maior que “0” (zero).
...
aplicando-se a mesma redução da base de cálculo do ICMS ST na tributação, se houver.
Campo 11 (VL_UNIT_ICMS_OP_CONV) – Preenchimento: Nos casos de direito a crédito do imposto pela não
ocorrência do fato gerador presumido e desfazimento da ST, corresponde ao valor do ICMS da operação própria do sujeito
passivo por substituição do qual a mercadoria tenha sido recebida diretamente ou o valor do ICMS que seria atribuído à
operação própria do contribuinte substituído do qual a mercadoria tenha sido recebida, caso estivesse submetida ao regime
comum de tributação, calculado conforme a legislação de cada UF, considerando unidade utilizada para informar o campo
“QUANT_CONV”.
Para as UFs em que a legislação estabelecer que o valor desse campo corresponderá ao mesmo valor expresso no campo 12
(VL_UNIT_ICMS_OP_ESTOQUE_CONV), seu preenchimento será facultativo. O valor deste campo, quando obrigatório
Página 97 de 331

--- Página 98 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.7
Atualização: 26 de agosto de 2021
na UF, será utilizado para o cálculo do valor do ressarcimento/restituição do Campo 15
(VL_UNIT_ICMS_ST_CONV_REST), conforme fórmula abaixo:
...
complementação conforme Tabela 5.7
07 QUANT_CONV Quantidade do item no documento fiscal N - 06 O
de saída de acordo com as instruções de
preenchimento.
...
Campo 07 (QUANT_CONV) – Preenchimento: Quantidade do item devolvido na unidade de controle de estoque
informada no registro 0200 ou na unidade de comercialização, a critério de cada UF.
Validação: o valor informado no campo deve ser maior que “0” (zero).
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.7
Atualização: 26 de agosto de 2021
Campo 17 (VL_UNIT_BC_ICMS_ST _CONV_ENTRADA) - Preenchimento: A obrigatoriedade de informação deste
campo deve seguir a legislação de cada UF.
...
Campo 19 (VL_UNIT_FCP_ST_CONV_ENTRADA) - Preenchimento: A obrigatoriedade de informação deste campo
deve seguir a legislação de cada UF.
...
CST_ICMS, CFOP, e alíquota do ICMS.
10 VL_RED_BC Valor não tributado em função da redução da N - 02 O O
...
pai, C190.
Validação: Só pode ser preenchido quando o campo CST_ICMS do registro C190 assumir o valor x00, x10 ,x20, x51, x70
ou x90.
...
11 COD_CTA Código da conta analítica contábil debitada/ C - - OC
creditada
Observações:
Nível hierárquico - 2
Ocorrência –vários (por arquivo)
...
QUANT_CONV.
05 VL_UNIT_CONV Valor unitário da mercadoria, considerando N - 06 O
...
unidade utilizada para informar o campo
“QUANT_CONV”
09 VL_UNIT_ICMS_ST_EST Valor médio unitário do ICMS ST, N - 06 OC
OQUE_CONV incluindo FCP ST, das mercadorias em
...
Guia Prático EFD-ICMS/IPI – Versão 3.0.7
Atualização: 26 de agosto de 2021
c) igual a 2, os campos 08, 09, 10, 11 e 12 devem ser preenchidos e os campos 06, 13 e 14 não devem ser preenchidos. O
campo 07 pode ser preenchido de acordo com a legislação de cada UF.
...
que seria tributada se não houvesse ST, considerando a unidade utilizada para informar o campo “QUANT_CONV”,
aplicando-se a mesma redução da base de cálculo do ICMS ST na tributação, se houver.
Campo 07 (VL_UNIT_ICMS_OP_CONV) – Preenchimento: Nos casos de direito a crédito do imposto pela não
ocorrência do fato gerador presumido e desfazimento da ST, corresponde ao valor do ICMS da operação própria do sujeito
passivo por substituição do qual a mercadoria tenha sido recebida diretamente ou o valor do ICMS que seria atribuído à
operação própria do contribuinte substituído do qual a mercadoria tenha sido recebida, caso estivesse submetida ao regime
comum de tributação, calculado conforme a legislação de cada UF, considerando unidade utilizada para informar o campo
...
- Campo 07 (VL_UNIT_ICMS_OP_CONV)
= Campo 12 (VL_UNIT_ICMS_ST_CONV_REST)
a.2) Quando o campo 07 (VL_UNIT_ICMS_OP_CONV) não for obrigatório, de acordo com a legislação da UF, o
campo VL_UNIT_ICMS_ST_CONV_REST corresponde ao valor no campo 09
(VL_UNIT_ICMS_ST_ESTOQUE_CONV)
...
Este registro tem por objetivo identificar os equipamentos de ECF e deve ser informado por todos os contribuintes que utilizem
tais equipamentos na emissão de documentos fiscais.
...
08 VL_COFIN Valor da COFINS N - 02 OC
S
...
em operações de saída de documentos fiscais eletrônicos emitidos por terceiros (como por exemplo, o consórcio constituído
nos termos do disposto nos arts. 278 e 279 da Lei nº 6.404, de 15 de dezembro de 1976), devem ser informados com o código
de situação do documento igual a “08 - Documento Fiscal emitido com base em Regime Especial ou Norma Específica”. O
...
06 - AS - Alta Tensão Subterrâneo06
07 - B1 - Residencial 07
08 - B1 - Residencial Baixa Renda08
09 - B2 - Rural 09
Página 132 de 331
...
4.4.2 da Nota Técnica, instituída pelo Ato COTEPE/ICMS nº 44/2018 e alterações. Se o modelo do documento for 66, o
...
Validação: obrigatório quando COD_MOD_DOC_REF for igual a “66”. Será conferido o dígito verificador (DV) da chave
...
Campo 37 (NUM_DOC_REF) - Preenchimento: número do documento fiscal substituído. Validação: O valor informado
no campo deve ser maior que “0” (zero). Não deve ser informado quando COD_MOD_DOC_REF for diferente de “06”.
Quando COD_MOD_DOC_REF for igual a “06”, é obrigatória a informação simultânea de SER_DOC_REF,
NUM_DOC_REF e MES_DOC_REF, ou a informação de HASH_DOC_REF. Se HASH_DOC_REF for informado, este
campo deve ter conteúdo VAZIO “||”.
...
21 COD_CTA Código da conta analítica contábil debitada/ C - - OC
creditada
Observações:
Nível hierárquico - 3
Ocorrência - 1:N
...
lançamentos de natureza meramente financeira e que não tenham nenhuma repercussão tributária para o ICMS, nem
lançamentos referentes à energia injetada. Quando essa energia injetada implicar isenção incidente sobre a energia fornecida,
Página 137 de 331

--- Página 138 ---
Guia Prático EFD-ICMS/IPI – Versão 3.0.7
Atualização: 26 de agosto de 2021
a parcela beneficiada pela isenção deverá ser vinculada ao CST_ICMS 40, contendo valor zero nos campos VL_BC_ICMS e
VL_ICMS. Para mais informações, consulte o arquivo de perguntas frequentes. Permanecendo dúvida, consulte a SEFAZ de
sua jurisdição, por meio do e-mail corporativo localizado no endereço: http://sped.rfb.gov.br/pagina/show/1577
As distribuidoras de energia estabelecidas no DF deverão apresentar a consolidação dos itens de NF3e referentes às
prestações de serviços dentro do campo de incidência do ISS (CFOP 5933), informando o valor zero nos campos
...
item 4.3.1 da Nota Técnica, instituída pelo Ato COTEPE/ICMS nº 44/2018 e alterações.
ICMS Normal:
Página 138 de 331
...
Campo 05 (VL_OPR) – Preenchimento: Na combinação de CST_ICMS, CFOP e ALIQ_ICMS, informar neste campo o
valor fornecido somado aos valores de outras despesas acessórias, subtraído o desconto incondicional.
...
02 VL_FCP_OP operação própria, na combinação de CST_ICMS, CFOP e
N - 02 OC OC
alíquota do ICMS
Valor do Fundo de Combate à Pobreza (FCP) vinculado à
03 VL_FCP_ST operação de substituição tributária, na combinação de
N - 02 OC OC
CST_ICMS, CFOP e alíquota do ICMS.
Observações:
Nível hierárquico – 4
...
valores válidos são [01, 02, 03, 04, 05, 06, 07, 08]. Se o modelo for 29 (água canalizada), o valor deve constar da Tabela
4.4.2 da Nota Técnica, instituída pelo Ato COTEPE/ICMS nº 44/2018 e alterações.
...
Este registro tem por objetivo informar a numeração dos documentos cancelados da consolidação diária dos documentos fiscais
do C600.
Nº Campo Descrição Tipo Tam Dec Entr Saída
...
REGISTRO C610: ITENS DO DOCUMENTO CONSOLIDADO (CÓDIGO 06), NOTA FISCAL/
CONTA DE FORNECIMENTO D'ÁGUA CANALIZADA (CÓDIGO 29) E NOTA
...
08 CST_ICMS Código da Situação Tributária, conforme N 003* - O
...
RACAO_CONV caso não houvesse a ST, considerando
unidade utilizada para informar o campo
“QUANT_CONV”, aplicando-se a
mesma redução da base de cálculo do
...
Alíquota do ICMS.
Nº Campo Descrição Tipo Tam Dec Entr Saída
01 REG Texto fixo contendo "C850" C 004 - Não O
02 CST_ICMS Código da Situação Tributária, conforme a Tabela N 003 - apresentar
O
indicada no item 4.3.1
...
06 VL_BC_ICMS Valor acumulado da base de cálculo do ICMS, N - 2 O
referente à combinação de CST_ICMS, CFOP, e
Página 154 de 331
...
ICMS.
08 COD_OBS Código da observação do lançamento fiscal (campo C 006 -
OC
02 do registro 0460)
Observações:
Nível hierárquico: 3
...
04 UNID Unidade adotada para informar o campo C 006 - O
QUANT_CONV.
05 VL_UNIT_CONV Valor unitário da mercadoria, considerando N - 03 O
a unidade utilizada para informar o campo
“QUANT_CONV”.
...
indicada no item 4.3.1
03 CFOP Código Fiscal de Operação e Prestação do agrupamento N 004 - O
de itens
04 ALIQ_ICMS Alíquota do ICMS N 006 02 OC
05 VL_OPR “Valor total do CF-e” na combinação de CST_ICMS, N - 02 O
CFOP e ALÍQUOTA DO ICMS, correspondente ao Não
somatório do valor líquido dos itens. apresentar
...
Este registro deve ser gerado para abertura do bloco D e indica se há informações sobre prestações ou contratações de serviços de
comunicação, transporte interestadual e intermunicipal, com o devido suporte do correspondente documento fiscal.
